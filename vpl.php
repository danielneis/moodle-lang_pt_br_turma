...
/**
 * Strings for component 'vpl', language 'pt_br', branch 'MOODLE_29_STABLE'
 *
 * @package   vpl
...
$string['defaultresourcelimits'] = 'Valor padrão para limite de returmas de execução';
...
$string['maxresourcelimits'] = 'Limite de returmas de execução';
...
$string['menuresourcelimits'] = 'Limite de returmas';
...
$string['resourcelimits'] = 'Limite de returmas';
