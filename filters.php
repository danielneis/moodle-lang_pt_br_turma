...
/**
 * Strings for component 'filters', language 'pt_br', branch 'MOODLE_30_STABLE'
 *
 * @package   filters
...
$string['anycourse'] = 'Qualquer turma';
...
$string['courserole'] = 'Papel na turma';
$string['courserolelabel'] = '{$a->label} está {$a->rolename} em {$a->coursename} na {$a->categoryname}';
$string['courserolelabelerror'] = '{$a->label} erro: turma {$a->coursename} não existe';
$string['coursevalue'] = 'valor na turma';
