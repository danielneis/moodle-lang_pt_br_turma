...
/**
 * Strings for component 'enrol_mnet', language 'pt_br', branch 'MOODLE_30_STABLE'
 *
 * @package   enrol_mnet
...
$string['mnet_enrol_description'] = 'Publique este serviço para permitir que administradores de {$a} inscrevam estudantes em turmas que você criou no seu servidor.<br/><ul><li><em>Dependência</em>: Você deve também <strong>publicar</strong> o serviço SSO (Provedor de Serviço) para {$a}.</li><li><em>Dependência</em>: Você deve também <strong>subscrever</strong> no serviço SSO (Provedor de Identidade) em {$a}.</li></ul><br/>Subscrever este serviço para ser capaz de inscrever seus alunos em turmas em {$a}.<br/><ul><li><em>Dependência</em>: Você deve também <strong>subscrever</strong> o serviço SSO (Provedor de Serviço) em {$a}.</li><li><em>Dependência</em>: Você deve também <strong>publicar</strong> o serviço SSO (Provedor de Identidade) em {$a}.</li></ul><br/>';
$string['mnet_enrol_name'] = 'Cadastramento na Rede Moodle';
$string['pluginname'] = 'Inscrições remotas MNet';
$string['pluginname_desc'] = 'Permite que servidores MNet remotos inscrevam seus usuários nos suas turmas.';
$string['remotesubscriber'] = 'Servidores remotos';
$string['remotesubscriber_help'] = 'Selecione "Todos os servidores" para abrir esta turma para todos os pares MNET que esteja oferecendo ao serviço de inscrições remotas. Ou escolha um único provedor para tornar este turma disponível para seus usuários apenas.';
