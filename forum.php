...
$string['cannotcreateinstanceforteacher'] = 'Não foi possível criar um novo exemplo de módulo de turma para o fórum de professore';
...
$string['cannotmovetonotfound'] = 'Fórum de destino não foi encontrado nesta turma.';
...
$string['configmaxbytes'] = 'Tamanho máximo predefinido dos anexos de todos os fóruns do site (sujeito aos limites das turmas e outras configurações locais)';
...
$string['errorenrolmentrequired'] = 'Você precisa estar inscrito nesta turma para acessar este conteúdo';
...
$string['inforum'] = 'em {$a}';
$string['introblog'] = 'As mensagens deste fórum foram copiadas aqui automaticamente a partir dos blogs dos usuarios desta turma uma vez que essas entradas de blog não mais estão disponíveis.';
