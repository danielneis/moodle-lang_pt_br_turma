...
/**
 * Strings for component 'checklist', language 'pt_br', branch 'MOODLE_29_STABLE'
 *
 * @package   checklist
...
$string['emailoncompletebody'] = 'Usuário {$a->user} concluiu o checklist \'{$a->checklist}\' na turma \'{$a->coursename}\' . Veja o checklist aqui:';
$string['emailoncompletebodyown'] = 'Concluiu o checklist  \'{$a->checklist}\' na turma \'{$a->coursename}. Veja o checklist aqui:';
...
$string['importfromcourse'] = 'Toda turma';
...
$string['removeauto'] = 'Remover itens da turma';
