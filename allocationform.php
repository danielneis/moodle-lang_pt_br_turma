...
$string['noallocationforms'] = 'Formulários de atribuição não encontrados para esta turma';
...
$string['roleselect_help'] = 'Selecione o papel dos utilizadores sobre esta turma que será atribuído através deste formulário.';
$string['saved'] = 'Opções salvas, você pode agora retornar à turma';
