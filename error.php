...
$string['cannotaddcoursemodule'] = 'Não foi adicionado um novo módulo de turma';
$string['cannotaddcoursemoduletosection'] = 'Não foi adicionado o novo módulo de turma nesta seção';
...
$string['cannotassignrole'] = 'Impossível designar papéis na turma';
...
$string['cannotcreatecategory'] = 'O curso não foi inserida';
...
$string['cannotcreateorfindstructs'] = 'Erro ao criar ou buscar estruturas de seção para esta turma';
...
$string['cannotdeletecategorycourse'] = 'Falha ao excluir turma \'{$a}\'.';
$string['cannotdeletecategoryquestions'] = 'Não foi possível excluir questões do curso \'{$a}\'';
$string['cannotdeletecourse'] = 'Você não tem permissões para excluir esta turma';
...
$string['cannoteditsiteform'] = 'Você não pode editar o portal desta turma usando este formulário';
...
$string['cannotfindcategory'] = 'Não é possível encontrar o registro do curso no banco de dados pelo ID - {$a}';
$string['cannotfindcomponent'] = 'Impossível achar componente';
$string['cannotfindcontext'] = 'Não foi possível achar o contexto';
$string['cannotfindcourse'] = 'Não é possível encontrar a turma';
...
$string['cannothaveparentcate'] = 'Esto curso de turmas não pode ter pai!';
...
$string['cannotinsertgrade'] = 'Não é possível inserir item de nota sem id da turma!';
...
$string['cannotmarktopic'] = 'Não foi possível atribuir nota a este tópico nesta turma';
...
$string['cannotmovecourses'] = 'Não é possível mover as turmas do curso que estão em outro.';
...
$string['cannotremovefrommeta'] = 'Não foi possível apagar a turma selecionado deste metaturma!';
...
$string['cannotrestoreadminorcreator'] = 'Você tem que ser criador de turmas ou administrador para restaurar num nova turma!';
$string['cannotrestoreadminoredit'] = 'Você precisa ser professor com poder de edição ou administrador para restaurar na turma selecionado!';
...
$string['cannotsetparentforcatoritem'] = 'Não é possível definir o pai para o curso ou item da turma!';
$string['cannotsetpassword'] = 'Não foi possível definir senha de usuário!';
$string['cannotsetprefgrade'] = 'Não foi possível definir a preferência aggregationview a {$a} para este curso de notas';
...
$string['cannotshowhidecoursesincategory'] = 'Não é possível ocultar/mostrar as turmas neste curso, {$a}.';
...
$string['cannotupdatesubcourse'] = 'Não foi possível atualizar um turma filho!';
...
$string['categoryidnumbertaken'] = 'Número de identificação já é usado para outro curso';
$string['categorynamerequired'] = 'Nome do curso é necessário';
$string['categorytoolong'] = 'Nome do curso muito longo';
...
$string['coursedoesnotbelongtocategory'] = 'A turma não pertence a este curso';
$string['courseformatnotfound'] = 'Formato de turma \'{$a}\' não existe ou não foi reconhecido';
$string['coursegroupunknown'] = 'A turma correspondente ao grupo {$a} não foi definido';
$string['courseidnotfound'] = 'Id da turma não existe';
$string['courseidnumbertaken'] = 'Número ID já está sendo usado para outra turma ({$a})';
$string['coursemisconf'] = 'A turma está mal configurado';
$string['courserequestdisabled'] = 'Desculpe, mas a solicitação de turmas está desabilitada pelo administador';
...
$string['destinationcmnotexit'] = 'O módulo de turma de destino nao existe';
...
$string['groupexistforcourse'] = 'O grupo "{$a}" já existe nesse turma';
$string['groupexistforcoursewithidnumber'] = '{$a->problemgroup}: Grupo "{$a->name}" com id "{$a->idnumber}" já existe nesta turma';
...
$string['groupunknown'] = 'O grupo {$a} não é associado à turma especificado';
...
$string['idnumbertaken'] = 'Número ID já é usado em outra turma';
...
$string['invalidcourseid'] = 'Você está tentando usar um ID de turma inválido';
$string['invalidcourselevel'] = 'Nível de contexto incorreto';
$string['invalidcoursemodule'] = 'ID de módulo de turma não válido';
$string['invalidcoursenameshort'] = 'Nome breve de turma inválido';
...
$string['invalidsection'] = 'Os registros do módulo de turma tem uma seção inválida';
$string['invalidsesskey'] = 'O form foi recusado, a chave da sessão não é correta.';
$string['invalidshortname'] = 'Este nome breve de turma é inválido';
...
$string['loginasonecourse'] = 'Impossível entrar nesse turma.<br /> Você precisa finalizar a sessão "Logar como" antes de entrar em outra turma.';
...
$string['moduledisable'] = 'Este módulo ({$a}) foi desabilitado para esta turma';
...
$string['movecatcontentstoroot'] = 'Mover o conteúdo do curso para a raiz não é permitido. Você deve mover o conteúdo para uma categoria existente!';
$string['movecategorynotpossible'] = 'Você não pode mover o curso \'{$a}\' para a categoria selecionada.';
$string['movecategoryownparent'] = 'Você não pode fazer o curso \'{$a}\' um pai de si mesmo.';
$string['movecategoryparentconflict'] = 'Você não pode fazer do curso \'{$a}\' uma subcategoria de suas próprias subcursos.';
...
';
$string['needcoursecategroyid'] = 'Deve ser especificado o ID da turma ou do curso';
...
$string['nocategorydelete'] = 'O curso \'{$a}\' não pode ser apagada!';
$string['nocontext'] = 'O contexto desse turma é inválido';
...
$string['noinstances'] = 'Nenhuma instância de {$a} nesta turma!';
$string['nologinas'] = 'Você não pode logar como esse usuário';
$string['nonmeaningfulcontent'] = 'Nenhum conteúdo significativo';
$string['noparticipants'] = 'Nenhum participante encontrado para esta turma';
$string['noparticipatorycms'] = 'Desculpe, você não tem módulos de participação em turmas para informar';
...
$string['nopermissiontoimportact'] = 'Você não possui as devidas permissões para importar atividades para esta turma';
...
$string['nosite'] = 'Não foi possível achar um turma do primeiro nível!';
...
$string['notmemberofgroup'] = 'Você não é membro deste grupo da turma';
...
$string['reportnotavailable'] = 'Este tipo de informe só está disponível para a turma global';
...
$string['shortnametaken'] = 'Nome breve já é usado em um outra turma ({$a})';
...
$string['statsnodata'] = 'Não há dados disponíveis para essa combinação de turma e período de tempo';
...
$string['unknowncourseidnumber'] = 'ID de turma desconhecido "{$a}"';
$string['unknowncourserequest'] = 'pedido de turma desconhecido';
$string['unknowncoursesection'] = 'Tópico desconhecido na turma "{$a}"';
...
$string['unspecifycourseid'] = 'Deve ser especificado o ID da turma, o nome breve ou idnumber';
...
$string['usernotincourse'] = 'Este usuário não está nesta turma!';
...
$string['wrongsourcebase'] = 'URL do returma errada';
$string['wrongusernamepassword'] = 'Usuário/senha incorreto';
$string['wrongzipfilename'] = 'Nome do arquivo ZIP errado';
$string['wscouldnotcreateecoursenopermission'] = 'WS. Sem permissão para criar turma.';
...
$string['youcannotdeletecategory'] = 'Não é possível excluir o curso \'{$a}\' nem excluir ou mover os conteúdos.';
