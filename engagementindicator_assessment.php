...
$string['override_help'] = 'Algumas atividades de avaliação (ex: quiz) contêm um returma para configurar datas alternativas de vencimento para usuários individuais ou grupos de usuários. Este campo indica que data de vencimento do usuário foi modificada por uma substituição.';
