...
$string['noenrolledcoursesyet'] = 'Você ainda não está inscrito em nenhum turma deste site.';
...
$string['statsresources'] = 'Returmas';
...
$string['supportforums'] = 'Nossa comunidade de usuários comunica principalmente através de fóruns nos "turmas" disponíveis neste site Moodle. Você precisa "inscrever-se" na turma para enviar mensagens aos fóruns (a inscrição é totalmente gratuita).';
...
$string['top10sitesbycourses'] = 'Top 10 sites por turmas';
