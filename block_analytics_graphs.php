...
/**
 * Strings for component 'block_analytics_graphs', language 'pt_br', branch 'MOODLE_29_STABLE'
 *
...
$string['resources_by_week'] = 'Número de returmas acessados por semana';
...
$string['title_access'] = 'Distribuição de acesso a conteúdos (returmas, urls e páginas)';
$string['title_students'] = 'Alunos';
$string['topic'] = 'Tópico';
$string['total_accessed_resources'] = 'Total de returmas acessados';
$string['total_not_accessed_resources'] = 'Total de returmas não acessados';
