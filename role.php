...
$string['archetypecoursecreator'] = 'ARQUÉTIPO: Criador de turma';
...
Por exemplo, se a um usuário for atribuído o papel de estudante em um turma, ele também terá o papel de estudante em todas as atividades e blocos naquele turma.';
...
$string['backup:backupcourse'] = 'Fazer backup de turmas';
...
$string['category:create'] = 'Criar cursos';
$string['category:delete'] = 'Excluir cursos';
$string['category:manage'] = 'Gerenciar cursos';
$string['category:update'] = 'Atualizar cursos';
$string['category:viewhiddencategories'] = 'Ver cursos ocultas';
$string['category:visibility'] = 'Visualizar cursos ocultas';
...
$string['community:add'] = 'Utilize o bloco comunidade para pesquisar hubs e encontrar turmas';
$string['community:download'] = 'Faça o download de um turma do bloco da comunidade';
...
$string['course:changecategory'] = 'Alterar o curso da turma';
...
$string['course:create'] = 'Criar turmas';
$string['course:delete'] = 'Excluir turmas';
...
$string['course:publish'] = 'Publicar um turma em um hub';
...
$string['course:visibility'] = 'Ocultar/Mostrar turmas';
...
$string['legacy:coursecreator'] = 'PAPEL LEGADO: Criador de turma';
...
$string['managerdescription'] = 'Gerentes podem acessar turmas em modificá-los, usualmente não participam das turmas.';
...
$string['restore:restorecourse'] = 'Restaurar turmas';
...
$string['restore:viewautomatedfilearea'] = 'Restaurar turmas de backups automatizados';
$string['risks'] = 'Riscos';
...
$string['site:approvecourse'] = 'Aprovar criação de turma';
...
$string['site:import'] = 'Importar outras turmas dentro de um turma';
