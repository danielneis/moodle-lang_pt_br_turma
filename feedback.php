...
$string['feedback:mapcourse'] = 'Mapear turmas para pesquisas globais';
...
$string['file'] = 'Arquivo';
$string['filter_by_course'] = 'Filtrar por turma';
...
$string['mapcourse'] = 'Mapear pesquisas para as turmas';
$string['mapcourse_help'] = 'Por padrão, os formulários de pesquisa criados em sua página inicial estão disponíveis em todo o site e estarão disponíveis em todos as turmas usando o bloco de comentários. Você pode forçar a disponibilização do formulário de pesquisa, tornando-a um bloco aderente ou limitar os turmas em que um formulário será exibido pelo mapeamento para turmas específicos.';
$string['mapcourseinfo'] = 'Esta é uma pesquisa no nível do site que está disponível para todos as turmas usando o bloco de comentários. No entanto,você pode mapear os turmas disponíveis para mapeá-los. Localize a turma e mapei-o para esta pesquisa.';
$string['mapcoursenone'] = 'Nenhum turma foi mapeado. A pesquisa estará disponível a todos as turmas.';
$string['mapcourses'] = 'Mapear pesquisa para as turmas';
$string['mapcourses_help'] = 'Após ter selecionado o(s) turma(s) relevante(s) para a pesquisa, você pode associá-lo(s) com usando este mapa de turma(s). Várias turmas podem ser selecionados mantendo pressionada a tecla Ctrl (ou Apple, no Mac) e clicando nos nomes dos turmas. Um turma pode ser dissociada de uma pesquisa a qualquer momento.';
...
$string['search_course'] = 'Buscar turma';
$string['searchcourses'] = 'Buscar turmas';
$string['searchcourses_help'] = 'Procure pelo(s) código(s) ou nome(s) do(s) turma(s) que você deseja associar a esta pesquisa.
';
...
$string['sort_by_course'] = 'Ordenar por turma';
$string['start'] = 'Início';
...
$string['viewcompleted_help'] = 'Você pode ver formulários de completo de pesquisa, pesquisáveis por turma e / ou por pergunta.
