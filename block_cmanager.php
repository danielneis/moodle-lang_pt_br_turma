...
$string['approverequest_New'] = 'Nova turma foi criado';
$string['approverequest_Process'] = 'Processo de entrega iniciado';
$string['approverequest_Title'] = 'Instalação da turma solicitada - Aprovar pedido';
...
$string['cannotrequestcourse'] = 'Desculpe a sua conta não tem privilégios suficientes para solicitar um turma. Você precisa ser atribuído a uma função do sistema com privilégios suficientes.';
...
$string['cmanagerDisplay'] = 'Gerenciador de Pedidos de Turma';
$string['cmanagerDisplaySearchForm'] = 'Configurar Formulário de Solicitação - Página 1';
$string['cmanager:editrecord'] = 'Editar registro';
$string['cmanagerEnrolmentInstruction'] = 'Gerenciador de Pedidos de Turma pode gerar uma chave de inscrição automática ou você pode optar por solicitar ao usuário uma chave de inscrição de sua escolha.';
...
$string['cmanagerRequestBtn'] = 'Solicite uma nova configuração da turma';
$string['cmanager:viewconfig'] = 'Ver configuração';
$string['cmanager:viewrecord'] = 'Ver registro';
$string['cmanagerWelcome'] = 'Bem-vindo ao Gerenciador de Pedidos de Turma do moodle. Antes de solicitar um nova turma, por favor, verifique suas diretrizes locais.';
...
$string['configure'] = 'Configurar Gerenciador de Pedidos de Turma';
...
$string['configure_defaultStartDateInstructions'] = 'Por favor, selecione uma data de início padrão para novas turmas.';
...
$string['courserequestline1'] = 'Por favor, consulte as diretrizes internas para nomear turmas.';
...
$string['deny'] = 'Negar';
$string['denycourse'] = 'Negar pedido de turma';
...
$string['email_fullURL'] = 'URL completa para nova turma';
...
$string['entryFields_TextfieldOne'] = 'Configure campo de nome curto da turma';
$string['entryFields_TextfieldTwo'] = 'Configure campo de nome completo da turma';
...
$string['snamingConvetionInstruction'] = 'Por favor, escolha um formato de nome curto para turmas recém-criados';
