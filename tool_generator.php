...
$string['coursewithoutusers'] = 'A turma selecionado não tem usuários';
$string['createcourse'] = 'Criar turma';
...
$string['error_nocourses'] = 'Não há turmas para gerar o plano de teste';
$string['error_noforumdiscussions'] = 'A turma selecionado não contém discussões em fórums';
$string['error_noforuminstances'] = 'A turma selecionado não contém instâncias do módulo forum';
$string['error_noforumreplies'] = 'A turma selecionado não contém respostas nos fóruns';
$string['error_nonexistingcourse'] = 'A turma especificado não existe';
$string['error_nopageinstances'] = 'A turma selecionado não contém instâncias do módulo página';
...
$string['maketestcourse'] = 'Fazer turma de teste';
$string['maketestplan'] = 'Criar plano de teste JMeter';
$string['notenoughusers'] = 'A turma selecionado não tem usuários suficientes';
...
$string['sitesize_0'] = 'XS (~ 10MB; três turmas, criado em ~ 30 segundos)';
$string['sitesize_1'] = 'S (~ 50MB; oita turmas, criados em aproximadamente 2 minutos)';
$string['sitesize_2'] = 'M (~ 200MB; 73 turmas, criado em ~ 10 minutos)';
$string['sitesize_3'] = 'L (~ 1\'5GB; 277 turmas, criado em ~ 1\'5 horas)';
$string['sitesize_4'] = 'XL (~ 10GB; 1065 turmas, criados em ~ 5 horas)';
$string['sitesize_5'] = 'XXL (~ 20GB; 4177 turmas, criados em ~ 10 horas)';
...
Você precisa definir uma senha para os usuários da turma em config.php (por exemplo $CFG->tool_generator_users_password \'moodle\';). Não há valor padrão para esta senha para evitar usos não-intencionais da ferramenta. Você precisa usar a opção de atualização de senhas no caso dos usuários de suas turmas terem outras senhas ou elas forem geradas por tool_generator mas sem definir uma $CFG->tool_generator_users_password valor.

É parte do tool_generator por isso funciona bem com as turmas gerados pelos turmas e os geradores de site, ele também pode ser usado com qualquer turma que contenha, pelo menos:
...
$string['updateuserspassword_help'] = 'JMeter precisa fazer login como os usuários da turma, você pode definir a senha de usuários usando $CFG->tool_generator_users_password em config.php; essa configuração atualiza a senha do usuário de acordo com o turma $CFG->tool_generator_users_password. Ele pode ser útil no caso de você estiver usando um turma não gerada por tool_generator ou $CFG->tool_generator_users_password não foi definido quando criou as turmas de teste.';
