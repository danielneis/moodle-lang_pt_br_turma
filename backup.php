...
$string['norestoreoptions'] = 'Não existem cursos ou turmas existentes nos quais você possa restaurar.';
...
$string['qcategory2coursefallback'] = 'O curso de questões "{$a->name}", originalmente no contexto de sistema/turma no arquivo de backup, será criada no contexto de turma pela restauração';
$string['qcategorycannotberestored'] = 'O curso de questões "{$a->name}" não pôde ser criada pela restauração';
$string['question2coursefallback'] = 'O curso de questões "{$a->name}", originalmente no contexto de sistema/turma no arquivo de backup, será criada no contexto de turma pela restauração';
