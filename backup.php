...
$string['confirmnewcoursecontinuequestion'] = 'Uma turma (oculta) temporária será criada pelo processo de restauração. Para abortar a restauração, clique em cancelar. Não feche o navegador durante a restauração.';
$string['coursecategory'] = 'Categoria em que a turma será restaurada';
...
$string['importgeneralmaxresults'] = 'O número máximo de turmas listadas para importação';
$string['importgeneralmaxresults_desc'] = 'Isto controla o número de turmas que são listadas durante o primeiro passo do processo de importação';
...
$string['morecoursesearchresults'] = 'Mais de {$a} turmas encontradas, mostrando o primeiro de {$a} resultados';
...
$string['restoreexecutionsuccess'] = 'A turma foi restaurada com sucesso, clique no botão continuar abaixo para visualizar a turma que você restaurou.';
...
$string['restoretoexistingcourse'] = 'Restaurar em uma turma existente';
$string['restoretoexistingcourseadding'] = 'Mesclar o conteúdo do backup em uma turma existente';
$string['restoretoexistingcoursedeleting'] = 'Excluir o conteúdo de uma turma existente e restaurar o backup';
...
$string['selectacourse'] = 'Selecione uma turma';
...
$string['skiphidden'] = 'Ignorar turmas ocultas';
$string['skiphiddenhelp'] = 'Escolha se quer ou não ignorar turmas ocultas';
$string['skipmodifdays'] = 'Ignorar turmas não modificadas desde';
$string['skipmodifdayshelp'] = 'Optar por ignorar turmas que não foram modificadas desde um número de dias';
$string['skipmodifprev'] = 'Ignorar turmas não modificadas desde o backup anterior';
$string['skipmodifprevhelp'] = 'Escolha se as turmas que não foram modificadas desde o último backup automático devem ser ignorados.';
