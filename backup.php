...
$string['backupcourse'] = 'Backup da turma: {$a}';
$string['backupcoursedetails'] = 'Detalhes da turma';
$string['backupcoursesection'] = 'Seção: {$a}';
$string['backupcoursesections'] = 'Seções da turma';
...
$string['backupsection'] = 'Backup da seção da turma: {$a}';
...
$string['choosefilefromcoursebackup'] = 'Área de backup da turma';
$string['choosefilefromcoursebackup_help'] = 'Quando se faz backup de turmas usando as configurações padrão, os arquivos de backup serão armazenados aqui';
$string['choosefilefromuserbackup'] = 'Área de backup de arquivos privados do usuário';
$string['choosefilefromuserbackup_help'] = 'Quando se faz backup de turmas com a opção "Anonymize user information" (despersonalizar as informações de usuários) assinalada, os arquivos de backup serão armazenados aqui';
...
$string['confirmnewcoursecontinue'] = 'Novo aviso da turma';
$string['confirmnewcoursecontinuequestion'] = 'Um turma (oculto) temporário será criado pelo processo de restauração. Para abortar a restauração, clique em cancelar. Não feche o navegador durante a restauração.';
$string['coursecategory'] = 'Categoria em que a turma será restaurado';
...
$string['error_block_for_module_not_found'] = 'Instância órfã de bloco (id: {$a->bid}) para o módulo da turma (id:{$a->mid}) encontrada. Não será realizado backup para este bloco.';
$string['error_course_module_not_found'] = 'Módulo de turma órfão (id: {$a}) encontrado. Não será realizado backup para este módulo.';
...
$string['generalactivities'] = 'Incluir atividades e returmas';
...
$string['importcurrentstage0'] = 'Selecionar a turma';
...
$string['importgeneralmaxresults'] = 'O número máximo de turmas listados para importação';
$string['importgeneralmaxresults_desc'] = 'Isto controla o número de turmas que são listados durante o primeiro passo do processo de importação';
$string['importgeneralsettings'] = 'Padrões gerais de importação';
$string['importsuccess'] = 'Importação concluída. Clique em Continuar para retornar à turma.';
...
$string['morecoursesearchresults'] = 'Mais de {$a} turmas encontrados, mostrando o primeiro de {$a} resultados';
$string['moreresults'] = 'Existem muitos resultados, digite um termo de pesquisa mais específico.';
$string['nomatchingcourses'] = 'Não existem turmas a exibir';
$string['norestoreoptions'] = 'Não existem categorias ou turmas existentes nos quais você possa restaurar.';
...
$string['qcategory2coursefallback'] = 'A categoria de questões "{$a->name}", originalmente no contexto de sistema/turma no arquivo de backup, será criada no contexto de turma pela restauração';
$string['qcategorycannotberestored'] = 'A categoria de questões "{$a->name}" não pôde ser criada pela restauração';
$string['question2coursefallback'] = 'A categoria de questões "{$a->name}", originalmente no contexto de sistema/turma no arquivo de backup, será criada no contexto de turma pela restauração';
...
$string['restorecoursesettings'] = 'Configurações da turma';
$string['restoreexecutionsuccess'] = 'A turma foi restaurado com sucesso, clique no botão continuar abaixo para visualizar a turma que você restaurou.';
$string['restorefileweremissing'] = 'Alguns arquivos não puderam ser restaurados porque eles estavam faltando no backup.';
$string['restorenewcoursefullname'] = 'Novo nome de turma';
$string['restorenewcourseshortname'] = 'Novo nome curto da turma';
$string['restorenewcoursestartdate'] = 'Nova data de início da turma';
...
$string['restoretocourse'] = 'Restauração para a turma:';
$string['restoretocurrentcourse'] = 'Restaurar nesta turma';
$string['restoretocurrentcourseadding'] = 'Mesclar o conteúdo do backup com esta turma';
$string['restoretocurrentcoursedeleting'] = 'Excluir o conteúdo desta turma e restaurar o backup';
$string['restoretoexistingcourse'] = 'Restaurar em um turma existente';
$string['restoretoexistingcourseadding'] = 'Mesclar o conteúdo do backup em um turma existente';
$string['restoretoexistingcoursedeleting'] = 'Excluir o conteúdo de um turma existente e restaurar o backup';
$string['restoretonewcourse'] = 'Restaurar como um nova turma';
$string['restoringcourse'] = 'Restauração da turma em progresso';
$string['restoringcourseshortname'] = 'restaurando';
$string['rootenrolmanual'] = 'Restaurar como inscrições manuais';
$string['rootsettingactivities'] = 'Incluir atividades e returmas';
...
$string['rootsettinglogs'] = 'Incluir os logs da turma';
...
$string['setting_course_fullname'] = 'Nome da turma';
$string['setting_course_shortname'] = 'Nome curto da turma';
$string['setting_course_startdate'] = 'Data de início da turma';
...
$string['setting_overwriteconf'] = 'Sobrescrever as configurações da turma';
...
$string['skiphidden'] = 'Ignorar turmas ocultos';
$string['skiphiddenhelp'] = 'Escolha se quer ou não ignorar turmas ocultos';
$string['skipmodifdays'] = 'Ignorar turmas não modificados desde';
$string['skipmodifdayshelp'] = 'Optar por ignorar turmas que não foram modificados desde um número de dias';
$string['skipmodifprev'] = 'Ignorar turmas não modificados desde o backup anterior';
$string['skipmodifprevhelp'] = 'Escolha se as turmas que não foram modificados desde o último backup automático devem ser ignorados.';
...
$string['totalcoursesearchresults'] = 'Total de turmas: {$a}';
