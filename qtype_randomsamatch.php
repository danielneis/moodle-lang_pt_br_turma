...
$string['nosaincategory'] = 'Não existe nenhuma questão com resposta breve disponível no curso escolhida \'{$a->catname}\'. Escolha uma categoria diferente ou crie algumas questões nesta categoria.';
$string['notenoughsaincategory'] = 'Existem apenas {$a->nosaquestions} questões com resposta breve no curso escolhida \'{$a->catname}\'. Escolha outra categoria, adicione questões a esta categoria ou reduza o número de questões configuradas.';
