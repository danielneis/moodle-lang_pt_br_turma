...
$string['dedicationall'] = 'Dedicação de todos os membros da turma. Clique em qualquer nome para ver sua dedicação detalhada.';
...
$string['dedicationrow'] = 'Dedicação aa turma';
$string['dedication:use'] = 'Permitir o uso de dedicação aa turma';
$string['form'] = 'Configuração de dedicação aa turma';
...
$string['pagetitle'] = '{$a}: dedicação aa turma';
...
$string['pluginname'] = 'Dedicação aa turma';
...
$string['userdedication'] = 'Detalhes da dedicação aa turma de <em>{$a}</em>.';
