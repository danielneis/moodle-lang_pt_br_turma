...
$string['dedicationrow'] = 'Dedicação à turma';
$string['dedication:use'] = 'Permitir o uso de dedicação à turma';
$string['form'] = 'Configuração de dedicação à turma';
...
$string['pagetitle'] = '{$a}: dedicação à turma';
...
$string['pluginname'] = 'Dedicação à turma';
...
$string['userdedication'] = 'Detalhes da dedicação à turma de <em>{$a}</em>.';
