...
$string['mma.grades.contributiontocoursetotal'] = 'Contribuição ao total da turma';
$string['mma.grades.feedback'] = 'Feedback';
$string['mma.grades.grade'] = 'Notas';
...
$string['mma.messages.contactlistempty'] = 'lista de contatos vazia';
...
$string['mma.mod_assign.addsubmission'] = 'Adicionar envio';
$string['mma.mod_assign.allowsubmissionsfromdate'] = 'Permitir envios de';
$string['mma.mod_assign.attemptnumber'] = 'Número da tentativa';
$string['mma.mod_assign.cutoffdate'] = 'Data limite';
$string['mma.mod_assign.duedate'] = 'Data de entrega';
$string['mma.mod_assign.duedateno'] = 'Não há data de entrega';
$string['mma.mod_assign.submissions'] = 'Envios';
$string['mma.mod_assign.userwithid'] = 'Usuário com id {{id}}';
$string['mma.mod_assign.viewsubmission'] = 'Ver envios';
$string['mma.mod_book.errorchapter'] = 'Erro ao ler capítulo de livro';
...
$string['mma.mod_imscp.deploymenterror'] = 'Erro de pacote de conteúdo!';
...
$string['mm.core.cancel'] = 'Cancelar';
...
$string['mm.core.course'] = 'Curso';
$string['mm.core.error'] = 'Erro';
...
$string['mm.settings.deletesitefiles'] = 'Tem certeza que deseja deletar os arquivos baixados a partir deste site?';
...
$string['mm.sidemenu.mycourses'] = 'Minhas turmas';
