...
$string['modulename_help'] = 'O módulo de arquivo permite que um professor para fornecer um arquivo como um recursa turma. Sempre que possível, o arquivo será exibido na interface do turma, caso contrário, os alunos serão solicitados a fazer o download. O arquivo pode incluir arquivos de suporte, por exemplo uma página HTML pode ter incorporado imagens ou objectos Flash. Note-se que os alunos precisam ter o software adequado em seus computadores a fim de abrir o arquivo. Um arquivo pode ser usado * Para compartilhar apresentações em classe * Para incluir um mini website como um recurso turma * Para fornecer arquivos de projectos de determinados programas de software (por exemplo, Photoshop. Psd) para que os alunos podem editar e enviá-los para a avaliação';
