...
$string['aggregationposition_help'] = 'Esta opção define se as colunas da categoria da turma e total do cursoã so mostradas no começo ou no fim dos relatórios do livro de notas.';
...
$string['coursesettingsexplanation'] = 'Configurações da turma determinam como o livro de notas aparece para todos os participantes do curso.';
...
$string['nooutcomes'] = 'Os itens de resultados devem apontar para o resultado de um curso, mas não há resultados para esse turma. Deseja acrescentar um?';
