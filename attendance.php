...
/**
 * Strings for component 'attendance', language 'pt_br', branch 'MOODLE_29_STABLE'
 *
 * @package   attendance
...
$string['attendancenotstarted'] = 'Presença ainda não foi iniciada para esta turma';
...
$string['nosessionexists'] = 'Nenhuma sessão existe para esta turma';
