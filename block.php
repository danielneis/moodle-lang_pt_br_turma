...
/**
 * Strings for component 'block', language 'pt_br', branch 'MOODLE_30_STABLE'
 *
 * @package   block
...
$string['contexts_help'] = 'Contextos são tipos específicos de páginas, onde este bloco pode ser exibido dentro da localização original do bloco. Você terá opções diferentes aqui, dependendo da localização do bloco original e sua localização atual. Por exemplo, você pode restringir um bloco para que apareça apenas nas páginas do fórum em um turma. Para que isso aconteça, você deverá adicionar o bloco à turma (fazendo com que ele apareça em todas as sub-páginas), em seguida, entrar em um fórum e editar as configurações do bloco novamente para restringir a exibição apenas nas páginas do fórum.';
$string['createdat'] = 'Localização original do bloco';
$string['createdat_help'] = 'O local original onde o bloco foi criado. Blocos podem ser configurados para aparecerem em outros locais (contextos) dentro do local original. Por exemplo, um bloco criado em uma página de turma pode ser exibida em atividades dentro desse turma. Um bloco criado na primeira página pode ser exibido em todo o site.';
