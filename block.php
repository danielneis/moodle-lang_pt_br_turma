...
$string['createdat_help'] = 'O local original onde o bloco foi criado. Blocos podem ser configurados para aparecerem em outros locais (contextos) dentro do local original. Por exemplo, um bloco criado em uma página de turma pode ser exibida em atividades dentro desse curso. Um bloco criado na primeira página pode ser exibido em todo o site.';
