...
$string['courses'] = 'turmas';
$string['courseson'] = 'turmas em';
...
$string['hostcoursenotfound'] = 'Hospedeiro ou turma não encontrado';
...
$string['mnetidproviderdesc'] = 'Você pode usar este returma para obter um link no qual você pode fazer login se puder informar o endereço correto de email que case com o nome de usuário com o qual você tentou efetuar o login anteriormente.';
...
$string['nosite'] = 'Não foi achado a turma principal (site)';
