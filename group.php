...
$string['enrolmentkey_help'] = 'Uma senha de inscrição permite que o acesso aa turma seja restrito apenas àqueles que conhecem a senha. Se uma senha de acesso para um grupo é especificada, então o aluno que se inscreve no curso usando-a também passa a fazer parte desse grupo.';
...
$string['notingroup'] = 'Ignorar os usuários em grupos';
...
$string['selectfromgroup'] = 'Selecione membros do grupo';
$string['selectfromgrouping'] = 'Selecione membros do agrupamento';
