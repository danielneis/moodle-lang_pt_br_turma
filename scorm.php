...
$string['invalidmanifestresource'] = 'ATENÇÃO: Os seguintes returmas foram citados no seu manifesto mas não foram encontrados:';
...
$string['noprerequisites'] = 'Infelizmente você ainda não alcançou o nível de requisitos necessário para acessar este returma de aprendizagem';
$string['noreports'] = 'Nenhum relatório disponível';
$string['normal'] = 'Normal';
$string['noscriptnoscorm'] = 'O seu navegador não é compatível com javascript ou o javascript não está habilitado. O funcionamento deste returma pode ser afetado.';
...
$string['popuplaunched'] = 'Este pacote SCORM foi lançado em uma janela pop-up, se você acabar de ver este returma, clique aqui para voltar à página da turma';
