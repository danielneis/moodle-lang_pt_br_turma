...
$string['cachedef_eventsubscriptions'] = 'Este armazena a lista de assinaturas de eventos para turmas individuais';
...
$string['selectacourse'] = 'Escolher um turma';
$string['selectcourse'] = 'Visite este relatório no nível turma para obter uma lista de possíveis módulos';
