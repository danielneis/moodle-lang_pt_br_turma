...
$string['coursecategories'] = 'Filtrar categoria da turma';
$string['coursecategory'] = 'Curso no curso';
$string['coursechild'] = 'Cursos que são filhos de';
$string['coursededicationtime'] = 'Tempo de dedicação à turma';
...
$string['filtercategories'] = 'Filtrar cursos';
$string['filtercategories_summary'] = 'Filtrar por categoria';
$string['filtercoursecategories'] = 'Filtrar categoria de turma';
$string['filtercoursecategories_summary'] = 'Filtrar turmas por qualquer categoria pai';
$string['filtercoursemodules'] = 'Módulo da turma';
$string['filtercoursemodules_summary'] = 'Filtrar módulos da turma';
$string['filtercourses'] = 'Cursos';
$string['filtercourses_summary'] = 'Este filtro mostra uma lista de turmas . Apenas um turma pode ser selecionado de cada vez';
$string['filterenrolledstudents'] = 'Alunos inscritos na turma';
$string['filterenrolledstudents_summary'] = 'Filtrar um usuário (por ID) da turma matriculado';
...
$string['filtersubcategories'] = 'Categoria (Incluir sub-cursos)';
...
$string['filteruser_summary'] = 'Filtrar um usuário (por ID) de usuários atuais da turma';
...
$string['finalgradeincurrentcourse'] = 'Nota final da turma atual';
...
$string['includesubcats'] = 'incluir sub-cursos';
