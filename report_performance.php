...
$string['check_backup_details'] = 'Ativando backup automatizado irá criar automaticamente arquivos de todos as turmas no servidor no momento que você especificou.  Durante esse processo, ele irá consumir mais returmas do servidor e pode afetar o desempenho.';
...
$string['check_enablestats_details'] = 'Habilitando essa opção serão processados os logs em cronjob e algumas estatísticas serão reunidas. Dependendo da quantidade de tráfego em seu site, isso pode levar algum tempo. Durante esse processo, ele vai consumir mais returmas do servidor e pode afetar o desempenho.';
