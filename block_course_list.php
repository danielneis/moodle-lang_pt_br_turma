...
$string['confighideallcourseslink'] = 'Remover o link "Todas as turmas" da lista de turmas. (Essa configuração não afeta a visualização do administrador.)';
...
$string['owncourses'] = 'O administrador vê apenas os suas turmas';
