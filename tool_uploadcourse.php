...
$string['cannotrenameidnumberconflict'] = 'Não é possível renomear a turma, o número ID conflita com um curso existente';
...
$string['createorupdate'] = 'Criar novas turmas ou atualizar cursos existentes';
...
$string['updatemode_help'] = 'Se você permitir que cursos sejam atualizados, você também tem que dizer qual ferramenta será utilizada para atualizar as turmas.';
