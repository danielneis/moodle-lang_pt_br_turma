...
/**
 * Strings for component 'block_community', language 'pt_br', branch 'MOODLE_30_STABLE'
 *
...
$string['downloadingcourse'] = 'Fazendo download da turma';
$string['downloadingsize'] = 'Por favor, espere enquanto o arquivo da turma está sendo baixado ({$a->total}Mb)...';
$string['downloadtemplate'] = 'Criar turma de um modelo';
...
$string['enroldownload_help'] = 'Alguns turmas listados no hub selecionado informam que as pessoas podem acessar e participar dos mesmos no site original.

Outros são modelos de turmas fornecidos para você baixar e usar em seu próprio site Moodle.';
$string['enrollable'] = 'turmas que posso me inscrever';
...
$string['keywords_help'] = 'Você pode procurar por turmas contendo um texto específico no nome, descrição e outros campos do banco de dados.';
$string['langdesc'] = 'Idioma: {$a} -';
$string['language'] = 'Idioma';
$string['language_help'] = 'Você pode buscar turmas escritos em um idioma especifico.';
$string['licence'] = 'Licença';
$string['licence_help'] = 'Você pode procurar por turmas que são licenciados de maneira particular';
$string['moredetails'] = 'Mais detalhes';
$string['mycommunities'] = 'Minhas comunidades:';
$string['next'] = 'Próximo >>>';
$string['nocomments'] = 'Nenhum comentário';
$string['nocourse'] = 'Nenhum turma encontrado';
...
$string['removecommunitycourse'] = 'Remover turma comunitário';
$string['restorecourse'] = 'Restaurar turma';
$string['restorecourseinfo'] = 'Restaurar a turma?';
$string['screenshots'] = 'Screenshots';
$string['search'] = 'Busca';
$string['searchcommunitycourse'] = 'Busca por turma da comunidade';
$string['searchcourse'] = 'Busca por turma da comunidade';
...
$string['subject_help'] = 'Para restringir sua pesquisa aas turmas sobre um assunto específico, escolha um desta lista.';
