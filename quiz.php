...
$string['addarandomquestion_help'] = 'Quando uma pergunta aleatória é adicionada, isso resulta em uma questão escolhida aleatoriamente a partir do curso que está sendo inserida no questionário. Isto significa que diferentes alunos poderão receber uma seleção diferente de perguntas, e quando um questionário permite várias tentativas, para cada uma delas é possível conter uma nova seleção de perguntas.
';
...
$string['addingquestions'] = 'Neste lado da página você administra a sua base de dados de questões. As questões são organizadas em cursos e podem ser usadas por qualquer questionário desta turma ou de outras turmas.
...
$string['backtocourse'] = 'Voltar à turma';
...
$string['containercategorycreated'] = 'Esto curso foi criada para arquivar todas as cursos que foram movidas para o nível do site principal pelas seguintes razões:';
...
$string['groupsnone'] = 'Não há grupos nesta turma';
...
$string['noquestionsnotinuse'] = 'Esta pergunta aleatória não está em uso, uma vez que a suo curso está vazia.';
...
$string['publishedit'] = 'Você deve ter direitos de publicação de turmas para adicionar ou editar questões neste curso';
$string['qbrief'] = 'Q. {$a}';
$string['qname'] = 'nome';
...
$string['questioninuse'] = 'A pergunta \'{$a->questionname}\' é atualmente usada em:<br />{$a->quiznames}<br />A questão não será excluída destes questionários mas apenas das cursos.';
...
$string['randomnosubcat'] = 'Questões somente desso curso, não de suas subcursos';
$string['randomnumber'] = 'Número de questões aleatórias';
$string['randomquestionusinganewcategory'] = 'Pergunta aleatória utilizando uma novo curso';
...
$string['savedfromdeletedcourse'] = 'Salvo do seguinte turma cancelado: "{$a}"';
...
$string['url'] = 'URL';
$string['usedcategorymoved'] = 'Esto curso foi transferida ao nível do site porque é uma categoria compartilhada ainda em uso em outros questionários.';
...
$string['xhtml'] = 'XHTML';
$string['youneedtoenrol'] = 'Você deve se cadastrar nesta turma antes de tentar responder este questionário';
