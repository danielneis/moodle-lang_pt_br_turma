...
/**
 * Strings for component 'calendar', language 'pt_br', branch 'MOODLE_30_STABLE'
 *
 * @package   calendar
...
$string['course'] = 'Curso';
$string['courseevent'] = 'Evento da turma';
$string['courseevents'] = 'Eventos da turma';
...
$string['errorbeforecoursestart'] = 'Não é possível criar um evento em uma data anterior à data inicial da turma';
...
$string['eventsrelatedtocourses'] = 'Eventos relativos aas turmas';
...
$string['hidecourseevents'] = 'Ocultar eventos de turma';
...
$string['showcourseevents'] = 'Exibir eventos de turma';
...
$string['tt_hidecourse'] = 'Eventos da turma estão visíveis (clique para esconder)';
...
$string['tt_showcourse'] = 'Eventos da turma estão ocultos (clique para mostrar)';
...
$string['typecourse'] = 'Evento da turma';
