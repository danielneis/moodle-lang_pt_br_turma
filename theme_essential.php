...
/**
 * Strings for component 'theme_essential', language 'pt_br', branch 'MOODLE_29_STABLE'
 *
...
$string['categoryiconcategory'] = 'O ícone para o curso: {$a->category}.';
$string['categoryicondesc'] = 'Quando ativado você pode escolher um conjunto de ícones para cado curso de turmas.';
$string['categoryiconheading'] = 'Ícones de categoria';
$string['categoryiconheadingsub'] = 'Use ícones para representar as cursos';
$string['categoryiconinfo'] = 'Defina os ícones padrão para as cursos';
...
$string['defaultcategoryicon'] = 'Ícones padrão de cursos';
$string['defaultcategoryicondesc'] = 'Defina um ícone padrão para o curso';
...
$string['displaymycourses'] = 'Exibir turmas matriculados';
$string['displaymycoursesdesc'] = 'Exibir turmas matriculados para usuários no Menu Customizável';
...
$string['enablecustomcategoryicondesc'] = 'se habilitado, abaixo dessa seção você verá cado curso com uma opção de personalização, por favor salve depois de habilitar ou desabilitar essa opção.';
...
$string['layoutdesc'] = 'Este tema é projetado para colocar ambas as colunas do bloco ao lado. Se você preferir o layout da turma Moodle padrão, você pode marcar essa caixa e então será adotado layout da coluna no formato padrão (três colunas).';
...
$string['mycoursesinfo'] = 'Lista dinâmica de Turmas Inscritos';
$string['mycoursesinfodesc'] = 'Exibe uma lista dinâmica de turmas inscritos para o usuário.';
...
$string['usecategoryicondesc'] = 'Use ícones personalizados para as cursos';
