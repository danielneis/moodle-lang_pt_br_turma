...
$string['completionnotenabled'] = 'A conclusão de turma não está habilitada para esse curso e portanto não pode ser incluída no critério do emblema. Você pode habilitar a conclusão de curso nas configurações da turma.';
...
$string['criteria_4_help'] = 'Permite que um emblema seja atribuído a um usuário que concluiu a turma. Este critério pode conter parâmetros adicionais como nota mínima e data de conclusão do curso.';
$string['criteria_5'] = 'Conclusão de um conjunto de turmas';
$string['criteria_5_help'] = 'Permite que um emblema seja concedido a um usuário que concluiu um conjunto de turmas. Cada curso pode conter parâmetros adicionais como nota mínima ou data de conclusão de curso.';
...
$string['error:nocourses'] = 'A conclusão de turma não está habilitada para nenhum curso do site, então nenhum pode ser mostrado. A conclusão de curso pode ser habilitada nas configurações da turma.';
...
$string['localbadgesh_help'] = 'Todos os emblemas ganhos neste web site por completar cursos, atividades de turmas e outros requisitos.
...
$string['requiredcourse'] = 'Pelo menos um curso deve ser adicionado ao critério conjunto de turmas.';
...
Emblemas para atividades relacionadas com a turma deve ser criados no nível do curso. Emblemas do curso podem ser encontrados em Administração do curso > Emblemas.';
