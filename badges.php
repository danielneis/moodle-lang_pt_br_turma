...
$string['addcourse'] = 'Adicionar turmas';
$string['addcourse_help'] = 'Selecione todos as turmas que podem ser adicionados a essa requisição de badge. Mantenha pressioanda a tecla CTRL para selecionar vários itens.';
...
$string['allmethodcourseset'] = 'Todos as turmas selecionados estão completos';
...
$string['allowcoursebadges'] = 'Ativar emblemas da turma';
$string['allowcoursebadges_desc'] = 'Permite que emblemas sejam criados e concedidos no contexto da turma';
...
$string['anymethodcourseset'] = 'Qualquer um das turmas selecionados estar concluído';
...
$string['badgesview'] = 'Emblemas da turma';
...
$string['completionnotenabled'] = 'A conclusão de turma não está habilitada para esse turma e portanto não pode ser incluída no critério do emblema. Você pode habilitar a conclusão de turma nas configurações da turma.';
...
$string['coursebadgesdisabled'] = 'Emblemas de turma não estão habilitados neste site.';
$string['coursecompletion'] = 'Participantes precisam completar esta turma.';
...
$string['criteria_1_help'] = 'Permite que um emblema seja concedido a usuários baseado na conclusão de um conjunto de atividades de um determinada turma.';
$string['criteria_2'] = 'Atribuição manual por papel';
$string['criteria_2_help'] = 'Permite que um emblema seja concedido manualmente por um usuários que tenha um papel particular em um turma ou no site.';
$string['criteria_3'] = 'Participação social';
$string['criteria_3_help'] = 'Social';
$string['criteria_4'] = 'Conclusão de turma';
$string['criteria_4_help'] = 'Permite que um emblema seja atribuído a um usuário que concluiu a turma. Este critério pode conter parâmetros adicionais como nota mínima e data de conclusão do turma.';
$string['criteria_5'] = 'Conclusão de um conjunto de turmas';
$string['criteria_5_help'] = 'Permite que um emblema seja concedido a um usuário que concluiu um conjunto de turmas. Cada turma pode conter parâmetros adicionais como nota mínima ou data de conclusão de turma.';
...
$string['criteria_descr_4'] = 'Os usuários devem concluir a turma';
$string['criteria_descr_5'] = '<strong>{$a}</strong> dos seguintes turmas devem ser concluídos:';
...
$string['criteria_descr_short4'] = 'Concluir a turma';
...
$string['criteria_descr_single_4'] = 'Os usuários devem concluir a turma';
$string['criteria_descr_single_5'] = 'O seguinte turma deve ser concluído:';
...
$string['criteria_descr_single_short4'] = 'Concluir a turma';
...
$string['error:noactivities'] = 'Não há atividades com critérios de conclusão habilitadas nesta turma.';
...
$string['error:nocourses'] = 'A conclusão de turma não está habilitada para nenhum turma do site, então nenhum pode ser mostrado. A conclusão de turma pode ser habilitada nas configurações da turma.';
...
$string['error:nosuchcourse'] = 'Aviso: Este turma não está mais disponível.';
...
$string['error:notifycoursedate'] = 'Aviso: Emblemas associados com as conclusões de atividade e turma não serão emitidos até a data de início da turma.';
...
$string['localbadgesh_help'] = 'Todos os emblemas ganhos neste web site por completar turmas, atividades de turmas e outros requisitos.
...
$string['requiredcourse'] = 'Pelo menos um turma deve ser adicionado ao critério conjunto de turmas.';
...
$string['sitebadges_help'] = 'Emblemas do site só podem ser concedidos aos usuários para atividades relacionadas ao site. Esses incluem a conclusão de um conjunto de turmas ou partes de perfis de usuário. Emblemas do site também podem ser emitidos manualmente de um usuário para outro.

Emblemas para atividades relacionadas com a turma deve ser criados no nível do turma. Emblemas do turma podem ser encontrados em Administração do turma > Emblemas.';
