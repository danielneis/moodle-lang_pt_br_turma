...
$string['coursesavailableexplaination'] = 'Nota: O monitoramento de conclusão de turma precisa estar configurado em algum curso para que estes apareçam na lista a seguir';
...
$string['err_nocourses'] = 'O acompanhamento de conclusão de turma não está habilitado para nenhum outra turma e, por isto, nada pode ser mostrado. Você pode habilitar o acompanhamento de conclusão de curso nas configurações do curso.';
