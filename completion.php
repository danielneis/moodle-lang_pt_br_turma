...
$string['completionnotenabledforcourse'] = 'Acompanhamento de conclusão não está habilitado nesta turma';
...
$string['courseaggregation_all'] = 'TODOS as turmas selecionados precisam ser marcados como concluídos';
$string['courseaggregation_any'] = 'QUALQUER um das turmas selecionados precisa ser marcado como concluído';
$string['coursealreadycompleted'] = 'Você já completou esta turma';
$string['coursecomplete'] = 'Curso concluído';
$string['coursecompleted'] = 'Curso concluído';
$string['coursecompletion'] = 'Conclusão de turma';
$string['coursecompletioncondition'] = 'Condição: {$a}';
$string['coursegrade'] = 'Nota da turma';
$string['coursesavailable'] = 'Cursos disponíveis';
$string['coursesavailableexplaination'] = 'Nota: O monitoramento de conclusão de turma precisa estar configurado em algum turma para que estes apareçam na lista a seguir';
...
$string['dependenciescompleted'] = 'Conclusão de outras turmas';
...
$string['enablecompletion_help'] = 'Se habilitado, condições de conclusão de atividades e conclusão de turma poderão ser configuradas.';
...
$string['err_nocourses'] = 'O acompanhamento de conclusão de turma não está habilitado para nenhum outra turma e, por isto, nada pode ser mostrado. Você pode habilitar o acompanhamento de conclusão de turma nas configurações do turma.';
$string['err_nograde'] = 'Não foi fixada uma nota de aprovação para esta turma. Para habilitar estes critérios deve criar uma nota de aprovação para a turma.';
$string['err_noroles'] = 'Não há papéis com a permissão \'moodle/course:markcomplete\' nesta turma.';
$string['err_nousers'] = 'Não há cursistas nesta turma ou grupo para os que possa ser mostrada a informação de progresso na turma. (Por padrão, a informação de progresso só é mostrada para os cursistas, assim, este erro será mostrado se não houver cursistas. Os administradores podem alterar esta opção nas telas de administração).';
...
$string['eventcoursemodulecompletionupdated'] = 'Conclusão de módulo de turma atualizada';
$string['excelcsvdownload'] = 'Download em formato compatível com Excel (. csv)';
$string['fraction'] = 'Fração';
$string['graderequired'] = 'Nota de turma obrigatória';
...
$string['nocriteriaset'] = 'Não existem critérios de conclusão para esta turma';
$string['notcompleted'] = 'Não concluído';
$string['notenroled'] = 'Você não está inscrito como estudante nesta turma';
$string['nottracked'] = 'Você não está sendo monitorado pelo sistema de conclusão nesta turma';
...
$string['usealternateselector'] = 'Usar o seletor de turmas alternativo';
$string['usernotenroled'] = 'Usuário não está inscrito nesta turma';
