...
$string['cachedef_capabilities'] = 'Lista de returmas do sistema';
$string['cachedef_completion'] = 'Status de conclusão da atividade';
$string['cachedef_config'] = 'Definições de configuração';
$string['cachedef_coursecat'] = 'Lista de categoria de turma para um usuário em particular';
$string['cachedef_coursecatrecords'] = 'Registros de categoria de turma';
$string['cachedef_coursecattree'] = 'Árvore de categorias turma';
$string['cachedef_coursecontacts'] = 'Lista de contatos da turma';
...
$string['cachedef_groupdata'] = 'Informações do grupo de turma';
...
$string['cachedef_navigation_expandcourse'] = 'Navegação em turmas expansíveis';
...
$string['cachedef_suspended_userids'] = 'Lista de usuários suspensos por turma';
