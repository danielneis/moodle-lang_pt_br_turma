...
$string['configallowcoursethemes'] = 'Habilitando esta opção, os cursos podem ter seus próprios temas. Os temas da turma se sobrepõem a outras escolhas de tema (tema da plataforma, do usuário ou da sessão).';
...
$string['navsortmycoursessort_help'] = 'Isso determina se os cursos serão listados em Meus cursos de acordo com a ordem de classificação (ou seja, a ordem definida em Configurações > Administração do Site > Gerenciar os cursos e categorias) ou em ordem alfabética pelo ambiente da turma.';
...
$string['restorernewroleid_help'] = 'Se o usuário não tiver permissão para gerenciar a turma recém-restaurado, ele será inscrito automaticamente receberá este papel, se necessário. Selecione "Nenhum" se você não quer que os restauradores sejam capazes de gerenciar todos os cursos restaurados.';
