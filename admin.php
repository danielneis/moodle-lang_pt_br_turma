...
$string['configforcelogin'] = 'Normalmente a página inicial da instalação e a lista de cursos (mas não as turmas) podem ser vistos por quem não se inscreveu como usuário. Para forçar as pessoas a se registrarem antes de poder navegar no site, esta opção deve ser habilitada.';
...
$string['configmycoursesperpage'] = 'Número máximo de cursos a ser mostrado em qualquer lista das turmas de um usuário.';
...
$string['confignavshowcategories'] = 'Mostra categorias de cursos na barra de navegação e blocos de navegação. Isso não ocorre com as turmas em que o usuário está inscrito, esses ainda serão listados em Meus Cursos (mycourses) sem categorias.';
...
$string['coursecontact_desc'] = 'Esta opção permite que você controle quem aparece na descrição da turma. Usuários precisarão ter pelo menos um desses papéis em um curso para serem mostrados na descrição deste curso.';
$string['courselistshortnames'] = 'Mostrar os nomes de curso extendidos';
$string['courselistshortnames_desc'] = 'Se habilitado, os nomes das turmas serão abreviados, ao invés de mostrar os nomes completos nas listas de cursos. Se necessário, os nomes dos percursos prolongados pode ser personalizado através da edição da string de idioma \'courseextendednamedisplay\' utilizando o recurso de personalização da linguagem.';
...
$string['legacyfilesinnewcourses'] = 'Arquivos de cursos legados em novas turmas';
