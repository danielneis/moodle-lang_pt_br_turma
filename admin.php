...
$string['configcourserequestnotify2'] = 'Usuários que serão notificados quando um curso for solicitado. Apenas usuários que podem aprovar solicitações de turma são listados aqui.';
$string['configcoursesperpage'] = 'Digite o número de turmas a serem exibidos por página em uma lista de cursos.';
...
$string['configfrontpagecourselimithelp'] = 'Número máximo de turmas a serem exibidos na primeira página do site na listagem de cursos.';
...
$string['confignavcourselimit'] = 'Limita o número de turmas mostrados para usuários não autenticados ou que não estejam inscritos em algum curso.';
...
$string['configuseblogassociations'] = 'Os usuários devem ser capazes de organizar seus blogs associando entradas com cursos e módulos de turmas?';
...
$string['coursecontact_desc'] = 'Esta opção permite que você controle quem aparece na descrição da turma. Usuários precisarão ter pelo menos um desses papéis em um curso para serem mostrados na descrição desta turma.';
...
$string['legacyfilesaddallowed_help'] = 'Se um curso tem arquivos da turma de legado, permitir que novos arquivos e pastas a serem adicionados a ele.';
$string['legacyfilesinnewcourses'] = 'Arquivos de turmas legados em novas turmas';
$string['legacyfilesinnewcourses_help'] = 'Por padrão, as áreas de arquivos de turmas legados estão disponíveis apenas em cursos atualizados. Por favor, observe que algumas coisas, como backup e restauração de uma única atividade, não são compatíveis com essa configuração.';
...
$string['navshowmycoursecategories_help'] = 'Se habilitado, as categorias de turma serão exibidas em Meus cursos na navegação.';
$string['navsortmycoursessort'] = 'Classificar meus cursos';
$string['navsortmycoursessort_help'] = 'Isso determina se as turmas serão listados em Meus cursos de acordo com a ordem de classificação (ou seja, a ordem definida em Configurações > Administração do Site > Gerenciar os cursos e categorias) ou em ordem alfabética pelo ambiente da turma.';
