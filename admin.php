...
$string['configallowcategorythemes'] = 'Habilitando esta opção, os temas poderão ser escolhidos a nível de categoria. Isso irá afetar todas os cursos e turmas filhas, a não ser que elas tenham seus próprios temas. AVISO: Habilitar temas de cursos pode afetar a performance.';
...
$string['configcourserequestnotify'] = 'Informe o usuário a ser notificado quando um nova turma for solicitada.';
$string['configcourserequestnotify2'] = 'Usuários que serão notificados quando uma turma for solicitada. Apenas usuários que podem aprovar solicitações de turma são listadas aqui.';
$string['configcoursesperpage'] = 'Digite o número de turmas a serem exibidas por página em uma lista de turmas.';
$string['configcourseswithsummarieslimit'] = 'O número máximo de turmas listadas incluindo resumos antes de voltar para listagem simples.';
...
$string['configdefaultrequestedcategory'] = 'Categoria padrão para novas turmas aprovadas';
...
$string['configforcelogin'] = 'Normalmente a página inicial da instalação e a lista de turmas (mas não as turmas) podem ser vistas por quem não se inscreveu como usuário. Para forçar as pessoas a se registrarem antes de poder navegar no site, esta opção deve ser habilitada.';
...
$string['configmycoursesperpage'] = 'Número máximo de turmas a ser mostradas em qualquer lista das turmas de um usuário.';
...
$string['confignavcourselimit'] = 'Limita o número de turmas mostradas para usuários não autenticados ou que não estejam inscritos em alguma turma.';
...
$string['confignavshowcategories'] = 'Mostra cursos de turmas na barra de navegação e blocos de navegação. Isso não ocorre com as turmas em que o usuário está inscrito, esses ainda serão listados em Meus Cursos (mycourses) sem cursos.';
...
$string['configprofilesforenrolledusersonly'] = 'Para previnir o mal uso por spammers, as descrições dos perfis de usuários que ainda não estão inscritos em nenhuma turma são escondidas. Novos usuários devem se inscrever em pelo menos uma turma para poderem adicionar uma descrição no perfil.';
...
$string['configrequestcategoryselection'] = 'Permitir a escolha de um curso ao solicitar uma turma.';
...
$string['configstatsuserthreshold'] = 'Esta configuração define o número mínimo de usuários inscritos em uma turma para ele ser incluído nos cálculos de estatísticas.';
...
$string['coursecontact_desc'] = 'Esta opção permite que você controle quem aparece na descrição da turma. Usuários precisarão ter pelo menos um desses papéis em uma turma para serem mostrados na descrição desta turma.';
$string['courselistshortnames'] = 'Mostrar os nomes de turma extendidos';
$string['courselistshortnames_desc'] = 'Se habilitado, os nomes das turmas serão abreviados, ao invés de mostrar os nomes completos nas listas de turmas. Se necessário, os nomes dos perecursos prolongados pode ser personalizado através da edição da string de idioma \'courseextendednamedisplay\' utilizando o recurso de personalização da linguagem.';
...
$string['courserequestnotifyemail'] = 'O usuário {$a->user} solicitou uma nova turma em {$a->link}';
...
$string['creatornewroleid'] = 'Papel do criador em turmas novas';
$string['creatornewroleid_help'] = 'Se o usuário não tiver permissão para gerenciar a nova turma, o usuário é automaticamente inscrito com este perfil de usuàrio.';
$string['cron'] = 'Cron';
...
$string['legacyfilesaddallowed_help'] = 'Se uma turma tem arquivos da turma de legado, permitir que novos arquivos e pastas a serem adicionados a ele.';
...
$string['modeditingmenu_desc'] = 'Se habilitado, muitos dos ícones de edição de atividades, que são exibidos quando a edição está ligada, serão exibidos como um menu de poções. Isso reduz o conteúdo na tela ao editar uma turma escondendo os ícones até que eles sejam necessários.';
...
$string['navadduserpostslinks_help'] = 'Se habilitado, dois links serão adicionados para cada usuário na navegação, um para ver as discussões que o usuário tenha iniciado e outro para as mensagens o usuário postou em fóruns do site ou em turmas específicas.';
$string['navcourselimit'] = 'Limite de turma';
$string['navexpandmycourses'] = 'Mostrar "Minhas turmas" expandidos no Painel';
$string['navexpandmycourses_desc'] = 'Se ativado, "Minhas turmas" é inicialmente mostrado expandido no bloco de navegação no Painel.';
...
$string['navshowallcourses'] = 'Mostrar todoa as turmas';
...
$string['navshowmycoursecategories'] = 'Exibir cursos em Minhas turmas';
$string['navshowmycoursecategories_help'] = 'Se habilitado, as cursos de turma serão exibidas em Minhas turmas na navegação.';
$string['navsortmycoursessort'] = 'Classificar minhas turmas';
$string['navsortmycoursessort_help'] = 'Isso determina se as turmas serão listadas em Minhas turmas de acordo com a ordem de classificação (ou seja, a ordem definida em Configurações > Administração do Site > Gerenciar as turmas e cursos) ou em ordem alfabética pelo ambiente da turma.';
...
$string['restorernewroleid_help'] = 'Se o usuário não tiver permissão para gerenciar a turma recém-restaurada, ele será inscrito automaticamente receberá este papel, se necessário. Selecione "Nenhum" se você não quer que os restauradores sejam capazes de gerenciar todos as turmas restauradas.';
