...
$string['configallowcategorythemes'] = 'Habilitando esta opção, os temas poderão ser escolhidos a nível de categoria. Isso irá afetar todas as cursos e turmas filhos, a não ser que eles tenham seus próprios temas. AVISO: Habilitar temas de cursos pode afetar a performance.';
...
$string['configdefaultrequestcategory'] = 'Cursos requisitados por usuários serão automaticamente colocados neste curso.';
...
$string['confignavshowcategories'] = 'Mostro cursos de turmas na barra de navegação e blocos de navegação. Isso não ocorre com as turmas em que o usuário está inscrito, esses ainda serão listados em Meus Cursos (mycourses) sem cursos.';
...
$string['configrequestcategoryselection'] = 'Permitir a escolha de um curso ao solicitar um turma.';
...
$string['configsitemaxcategorydepthhelp'] = 'Especifica a profundidade máxima de subcursos a serem exibidas quando mostrar a lista de cursos ou lista de combinação. Categorias de níveis mais profundos irão aparecer como links e os usuários poderão expandi-las requisitando através de AJAX.';
...
$string['configvisiblecourses'] = 'Mostre turmas em cursos ocultas';
...
$string['coursemgmt'] = 'Gerenciar turmas e cursos';
...
$string['linkadmincategories'] = 'Link paro cursos do admin';
...
$string['navshowcategories'] = 'Mostrar cursos de turmas';
...
$string['navshowmycoursecategories'] = 'Exibir cursos em Meus turmas';
$string['navshowmycoursecategories_help'] = 'Se habilitado, as cursos de turma serão exibidas em Meus turmas na navegação.';
$string['navsortmycoursessort'] = 'Classificar meus turmas';
$string['navsortmycoursessort_help'] = 'Isso determina se as turmas serão listados em Meus turmas de acordo com a ordem de classificação (ou seja, a ordem definida em Configurações > Administração do Site > Gerenciar os turmas e cursos) ou em ordem alfabética pelo ambiente da turma.';
...
$string['profileconfirmcategorydeletion'] = 'Há {$a} campo(s) nesso curso, que será(ão) movido(s) para a categoria acima (ou abaixo se estiver na categoria mais elevada).<br /> Você ainda deseja excluir essa categoria?';
...
$string['profilecreatecategory'] = 'Criar uma novo curso de perfil';
$string['profilecreatefield'] = 'Criar um novo campo de perfil:';
$string['profilecreatenewcategory'] = 'Criando uma novo curso';
