...
$string['incorrectlyconfigured'] = 'Este plugin foi configurado incorretamente. Não se destina a ser adicionado a um turma desta forma. Por favor, contate o administrador do sistema para configurar o plugin mod_engagement como oculto.';
