...
$string['modulename_help'] = 'Registro de Presença calcula o tempo que os usuários passam trabalhando em turmas online. <br /> Opcionalmente permite o registro atividades offline do usuário. <br /> Dependendo do modo de rastreamento, o registro pode rastrear as atividades em uma única turma, em todas as turmas do mesmo curso ou em todas os turmas "Meta ligados" no Curso que Registro de Presença esteja incluído <br />Sessões de trabalho online são calculadas com os registros de log gravados pelo Moodle. <br /> <b>Novas sessões on-line são adicionados com algum atraso pelo cron, após o logout do usuário.</b>';
...
$string['offline_session_ref_course_help'] = 'Selecione a turma no qual o trabalho offline foi realizado ou o tópico do turma abordado no trabalho.';
...
$string['offlinespecifycourse_help'] = 'Permitir que o usuário selecione a turma da sessão offline relacionada. <br /> Esta opção só tem sentido se registro de presença estiver no modo de rastreamento para mais de um turma(Por exemplo: mode de rastreamento "Categoria" ou "Meta-ligado")';
...
$string['select_a_course_if_any'] = '- Selecione um turma, se for o caso -';
