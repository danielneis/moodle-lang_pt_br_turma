...
/**
 * Strings for component 'aspirelist', language 'pt_br', branch 'MOODLE_29_STABLE'
 *
 * @package   aspirelist
...
$string['configcodetable'] = 'Opcional. O nome de uma tabela personalizada no banco de dados do Moodle contendo os códigos da lista Talis Aspire mapeadas contra um atributa turma Moodle.';
$string['configcourseattribute'] = 'Opcional. O atributo de turma exclusivo que é mapeado contra seus códigos de Talis Aspire na tabela custom (normalmente id, idnumber ou nome breve).';
...
$string['courseattribute'] = 'Características da turma';
