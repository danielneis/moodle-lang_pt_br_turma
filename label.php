...
/**
 * Strings for component 'label', language 'pt_br', branch 'MOODLE_30_STABLE'
 *
 * @package   label
...
$string['dnduploadlabel'] = 'Adicionar imagem à página da turma';
$string['dnduploadlabeltext'] = 'Adicionar um rótulo na página da turma';
