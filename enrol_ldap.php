...
$string['autocreate'] = '<p>Se existirem inscrições para turmas que ainda não foram criados no Moodle, esses turmas podem ser criados automaticamente .</p><p> Caso você use a criação automática de turma, é recomendável que você remova as seguintes capacidades:
...
$string['cannotcreatecourse'] = 'Não é possível criar turma: faltam dados necessários no registro do LDAP!';
$string['cannotupdatecourse'] = 'Não é possível atualizar a turma: faltam dados obrigatórios no registro do LDAP! idnumber do turma: \'{$a->idnumber}\'';
$string['cannotupdatecourse_duplicateshortname'] = 'Não é possível atualizar a turma: Nome curto duplicado. Pulando o turma com idnumber \'{$a->idnumber}\'...';
$string['category'] = 'Categoria para turmas criados automaticamente';
...
$string['createcourseextid'] = 'CRIAR Usuário inscrito em turma inexistente \'{$a->courseextid}\'';
$string['createnotcourseextid'] = 'Usuário inscrito em um turma não existente \'{$a->courseextid}\'';
...
$string['objectclass'] = 'objectClass usado para buscar turmas. Normalmente é \'posixGroup\'.';
...
$string['pluginname_desc'] = '<p>Você pode usar um server LDAP para controlar as inscrições. Se presume que o ramo LDAP contenha grupos mapeados em relação aas turmas e que cada um destes grupos/turmas terá itens que identificam membros mapeados em relação aos estudantes.</p>
...
$string['template'] = 'Opcional: turmas criados automaticamente podem copiar as suas configurações a partir de um modelo de turma';
