...
$string['blogaboutthiscourse'] = 'Adicionar uma entrada sobre esta turma.';
...
$string['blogs'] = 'Blogs';
$string['blogscourse'] = 'Blogs da turma';
$string['blogssite'] = 'Blogs do site';
$string['blogtags'] = 'Tags do blog';
$string['cannotviewcourseblog'] = 'Você não tem permissões para visualizar blogs nesta turma';
$string['cannotviewcourseorgroupblog'] = 'Você não tem permissões para visualizar blogs nesta turma/grupo';
...
$string['publishtocourse'] = 'Usuários que compartilham a turma com você';
$string['publishtocourseassoc'] = 'Membros da turma associado';
$string['publishtocourseassocparam'] = 'Membros de {$a}';
$string['publishtogroup'] = 'Usuários que compartilham seu grupo';
$string['publishtogroupassoc'] = 'Membros de seu grupo na turma associado';
...
$string['viewcourseblogs'] = 'Ver todas as mensagens desta turma';
$string['viewentriesbyuseraboutcourse'] = 'Ver mensagens sobre esta turma por {$a}';
...
$string['viewmyentriesaboutcourse'] = 'Ver minhas mensagens sobre esta turma';
