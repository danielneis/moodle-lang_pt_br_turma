...
$string['deleteblogassociations_help'] = 'Se selecionado, as mensagens do blog não serão mais asssociadas a este curso ou a atividades ou recursos da turma. As mensagens não serão apagadas.';
