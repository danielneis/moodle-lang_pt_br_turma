...
/**
 * Strings for component 'report_security', language 'pt_br', branch 'MOODLE_30_STABLE'
 *
...
$string['check_google_details'] = '<p>A configuração Aberto ao Google permite que motores de busca entrem nas turmas com visitantes. Não há razão para habilitar esta configuração caso o acesso a visitantes esteja desabilitado.</p>';
...
$string['check_guestrole_details'] = '<p>O papel visitante é utilizado para visitantes, usuários não autenticados e acesso temporário aas turmas como visitante. Por favor, certifique-se que nenhuma ação arriscada é permitida a este papel.</p><p>O único papel legado permitido para o papel visitante é <em>Visitante</em>.</p>';
...
$string['check_riskbackup_details_users'] = '<p>Em consequência dos papéis ou sobreposições locais acima, as seguintes contas de usuários tem permissão de fazer backups contendo dados pessoais de quaisquer usuários inscritos nos suas turmas. Certifique-se que eles são (a) confiáveis e (b) protegidos por senhas fortes:</p> {$a}';
