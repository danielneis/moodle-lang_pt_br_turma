...
/**
 * Strings for component 'block_xp', language 'pt_br', branch 'MOODLE_29_STABLE'
 *
 * @package   block_xp
...
$string['rank'] = 'Posição';
$string['reallyresetdata'] = 'Deseja realmente resetar os níveis e pontos de experiência de todos nesta turma?';
