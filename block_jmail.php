...
$string['emailcopyheader'] = 'Esta é uma cópia da mensagem que você recebeu em um das turmas na sua caixa de correio.  Você poderá ver a mensagem completa aqui: {$a}';
