...
/**
 * Strings for component 'oublog', language 'pt_br', branch 'MOODLE_27_STABLE'
 *
 * @package   oublog
...
$string['visiblecourseusers'] = 'Visível para participantes desta turma';
