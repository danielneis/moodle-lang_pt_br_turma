...
$string['addcreator'] = 'Adicionar criador de turmas';
...
$string['addnewcategory'] = 'Adicionar uma novo curso';
...
$string['adminhelpassigncreators'] = 'Criadores de turma podem criar novas turmas';
$string['adminhelpassignsiteroles'] = 'Aplicar papéis definidos no site para usuários específicos';
$string['adminhelpassignstudents'] = 'Entrar em um turma e adicionar participantes usando o painel de administração';
...
$string['adminhelpcourses'] = 'Definir turmas e cursos e designar participantes';
...
$string['areyousuretorestorethisinfo'] = 'Mais tarde você terá a opção de adicionar este backup a um turma existente ou criar um turma novo.';
$string['asc'] = 'Crescente';
$string['assessment'] = 'Avaliação';
$string['assignadmins'] = 'Designar administradores';
$string['assigncreators'] = 'Designar criadores de turma';
...
$string['backtocourselisting'] = 'Voltar para a lista de turmas';
...
$string['backupfailed'] = 'Alguns turmas não foram salvos!';
...
$string['backupkeephelp'] = 'Quantos backups recentes de cada turma você quer manter? (os mais velhos serão removidos automaticamente)';
...
$string['categories'] = 'Categorias de Turmas';
$string['categoriesandcoures'] = 'Categorias e Turmas';
$string['category'] = 'Categoria';
$string['categoryadded'] = 'O curso \'{$a}\' foi adicionada';
$string['categorybulkaction'] = 'Ações em lote paro cursos selecionadas';
$string['categorycontents'] = 'Subcursos e turmas';
$string['categorycurrentcontents'] = 'Conteúdos de {$a}';
$string['categorydeleted'] = 'O curso \'{$a}\' foi removida';
$string['categoryduplicate'] = 'O curso \'{$a}\' já existe!';
...
$string['choosecourse'] = 'Escolha um turma';
...
$string['commentsnotenabled'] = 'Returma de comentários não está habilitado';
...
$string['confirmcoursemove'] = 'Tem certeza de que deseja mover esta turma ({$a->course}) para este curso ({$a->category})?';
...
$string['courseapprovedemail'] = 'O seu pedido de aceitação na turma {$a->name} foi aprovado e você foi designado como {$a->teacher}. Para acessar o seu turma vá à página {$a->url}';
$string['courseapprovedemail2'] = 'Seu turma solicitado, {$a->name}, foi aprovado. Para acessar seu nova turma, vá para {$a->url}';
$string['courseapprovedfailed'] = 'Não foi possível salvar a turma como aprovado!';
$string['courseapprovedsubject'] = 'O seu turma foi aprovado!';
$string['courseavailable'] = 'Este turma pode ser acessado pelos participantes';
$string['courseavailablenot'] = 'Este turma não pode ser acessado pelos participantes';
$string['coursebackup'] = 'Backup da turma';
$string['coursebulkaction'] = 'Ações em lote para turmas selecionados';
$string['coursecategories'] = 'Categorias de turma';
$string['coursecategory'] = 'Categoria da turma';
$string['coursecategorydeleted'] = 'Apagado curso de turmas {$a}';
$string['coursecategory_help'] = '<p>Algumas cursos de turma devem ter sido definidas previamente pelo administrador do sistema.</p>

<p>Por exemplo: "Ciências", "Economia", "Saúde Pública", etc.</p>

<p>Escolha o curso mais adequada ao seu turma.
   O curso escolhida determina a posição do seu turma
   na lista de turmas para que os alunos o encontrem
   com facilidade.</p>';
$string['coursecatmanagement'] = 'Gerenciamento de turma e categoria';
$string['coursecompletion'] = 'Andamento da turma';
$string['coursecompletions'] = 'Andamento das turmas';
$string['coursecreators'] = 'Criador de turmas';
$string['coursecreatorsdescription'] = 'Criadores de turmas podem criar novas turmas e agir como professores';
...
$string['coursefiles'] = 'Arquivos de turma legados';
$string['coursefilesedit'] = 'Editar arquivos de turmas antigos';
$string['coursefileswarning'] = 'Arquivos de turma estão obsoletos';
...
$string['courseformats'] = 'Formatos de turma';
$string['courseformatudpate'] = 'Atualizar formato';
$string['coursegrades'] = 'Notas';
$string['coursehelpcategory'] = 'Posicione a turma na listagem de turmas de forma que seja mais fácil para os estudantes encontrá-lo.';
...
$string['coursehelpmaximumupload'] = 'Define o tamanho máximo dos arquivos que podem ser enviados para esta turma, limitado pela configuração do site.';
...
$string['coursehelpnumberweeks'] = 'Número de seções na turma (aplica-se a apenas certos formatos de turma).';
...
$string['courseoverviewfiles_help'] = 'Arquivos de resumo da turma, tais como imagens, são exibidas na lista de turmas juntamente com o resumo.';
...
$string['coursereject'] = 'Rejeitar o pedido de aprovação de turma';
$string['courserejected'] = 'A turma foi rejeitado e o requerente foi notificado.';
$string['courserejectemail'] = 'Infelizmente o seu pedido de abertura de turma não foi aceito. Esta é a razão indicada:
{$a}';
$string['courserejectreason'] = 'Descreva as razões para rejeitar esta turma<br />(uma cópia será mandada por email ao autor do pedido)';
$string['courserejectsubject'] = 'O seu turma não foi aceito';
$string['coursereport'] = 'Relatório da turma';
$string['coursereports'] = 'Relatórios da turma';
$string['courserequest'] = 'Solicitação de turma';
$string['courserequestdetails'] = 'Detalhes da turma solicitado';
$string['courserequestfailed'] = 'Por alguma razão, sua solicitação de turma não pôde ser realizada.';
...
$string['courserequestreason'] = 'Razões para abrir esta turma';
$string['courserequestsuccess'] = 'Sua solicitação de turma foi realizada com sucesso. Será enviado um email para você informando se sua solicitação foi aprovada.';
$string['courserequestsupport'] = 'Informações adicionais para ajudar o administrador a avaliar esta solicitação';
$string['courserequestwarning'] = 'O usuário que solicitar matrícula nesta turma assumirá automaticamente o papel "{$a}".';
$string['courserestore'] = 'Restauração de turma';
$string['courses'] = 'Cursos';
$string['coursesectionsummaries'] = 'Sumários da seção de turma';
...
$string['coursesummary_help'] = 'A descrição da turma é exibida na lista de turmas. A busca de turmas inclui também os textos da descrição, além dos nomes das turmas.';
...
$string['createnewcategory'] = 'Criar novo curso';
...
$string['creatingcategoriesandquestions'] = 'Criando cursos e questões';
$string['creatingcoursemodules'] = 'Criando módulos da turma';
$string['creatingcourseroles'] = 'Criando atribuições de papéis e sobreposições no nível de turma';
...
$string['defaultcoursestudentdescription'] = 'Estudantes geralmente tem menos privilégios em um turma.';
...
$string['defaultcourseteacherdescription'] = 'Professores podem fazer tudo em um turma, alterar atividades e avaliar.';
...
$string['deletecategorycheck'] = 'Você tem certeza que deseja excluir definitivamente este curso <b>\'{$a}\'</b>?<br />As turmas serão transferidos para a categoria superior, se presente, ou para a categoria padrão';
$string['deletecategorycheck2'] = 'Se você excluir este curso, escolha o que fazer com seus turmas e subcursos.';
$string['deletecategoryempty'] = 'Esto curso está vazia.';
...
$string['deletecourse'] = 'Excluir um turma';
$string['deletecoursecheck'] = 'Tem certeza que quer excluir completamente esta turma e todos os seus dados?';
...
$string['dndcourse'] = 'Você pode arrastar e soltar esta turma para alterar a sua classificação ou para movê-lo para outro curso.';
...
$string['dontsortcategories'] = 'Não ordenar cursos';
$string['dontsortcourses'] = 'Não ordenar turmas';
...
$string['editcategorysettings'] = 'Editar opções do curso';
...
$string['entercourse'] = 'Clique para entrar nesta turma';
...
$string['eventcoursemodulecreated'] = 'Módulo de turma criado';
$string['eventcoursemoduledeleted'] = 'Módulo de turma excluído';
$string['eventcoursemoduleinstancelistviewed'] = 'Lista de instâncias de módulos de turmas visualizados';
$string['eventcoursemoduleupdated'] = 'Módulo de turma atualizado';
...
$string['eventcoursesectionupdated'] = 'Tópico de turma atualizado';
...
$string['existingcreators'] = 'Criadores de turmas existentes';
...
$string['findmorecourses'] = 'Buscar mais turmas...';
...
$string['format_help'] = 'O formato de turma determina o layout da página da turma.
...
* Formato semanal - A página da turma é organizada em seções semanais, com a primeira semana começando na data de início do turma';
...
$string['frontpagecategorynames'] = 'Lista de cursos';
$string['frontpagecourselist'] = 'Lista de turmas';
$string['frontpagecoursesearch'] = 'Caixa de pesquisa da turma';
$string['frontpagedescription'] = 'Descrição da página inicial';
$string['frontpagedescriptionhelp'] = 'Esta descrição pode ser mostrada na página principal utilizando o bloco descrição de turma/site.';
...
$string['fullnamecourse_help'] = 'O nome completo da turma é apresentado no topo de cada página do turma e na lista de turmas.';
...
$string['guestuserinfo'] = 'Este é um tipo de usuário especial que tem acesso a alguns turma com permissão limitada à leitura.';
$string['help'] = 'Ajuda';
...
$string['hiddensections_help'] = '<P>Estas opções permitem que você decida como seções ocultas no seu turma serão exibidas para os estudantes.</p>

<p>A opção padrão define que as seções aparecerão aos estudantes com a área das atividades contraída e com a cor da seção alterada. A seção é visualizada mas os conteúdos da seção ficam ocultos. Isto pode ser útil em turmas com o formato semanal, para indicar semanas de férias, por exemplo.
</p>
...
$string['idnumbercoursecategory'] = 'Número ID do curso';
$string['idnumbercoursecategory_help'] = 'O número ID de um curso de turma é utilizado apenas quando comparando a categoria com sistemas externos e não é exibido em nenhum local no site. Caso a categoria possua um código oficial isto pode ser inserido, caso contrário o campo pode ser deixado em branco.';
$string['idnumbercourse_help'] = '<P>O ID de um turma é usado apenas nos processos de comunicação com sistemas externos - não é visualizado na interface da turma.  Se você tem um código oficial de identificação do turma, utilize-o para preencher este campo. Em caso contrário, deixe o campo vazio.
</p>';
...
$string['importdatafinished'] = 'Importação concluída! Siga para o seu turma';
$string['importdatafrom'] = 'Buscar um turma para importar os seus dados:';
...
$string['includesitefiles'] = 'Incluir arquivos do site usados nesta turma';
...
$string['listofcourses'] = 'Lista de turmas';
...
<li>Acesse o seu turma clicando o nome correspondente na lista de turmas disponíveis.</li>
<li>Se for pedido um código de inscrição use a senha que foi fornecida pelo administrador ou pelo professor. Esta senha é reservada aos usuários do site inscritos na turma e será necessária apenas na primeira vez que você entrar no turma.</li>
...
$string['managecategorythis'] = 'Gerenciar este curso';
$string['managecourses'] = 'Administrar turmas';
...
$string['maximumupload_help'] = '<P>Estas opções definem o tamanho máximo dos documentos que os estudantes desta turma podem enviar ao servidor, dentro dos limites globais estabelecidos pelo administrador do site.</p>
...
$string['maxnumberweeks_desc'] = 'O valor máximo no menu "número de seções" (aplicável apenas a alguns formatos de turma)';
$string['maxnumcoursesincombo'] = 'Navegar em <a href="{$a->link}">{$a->numberofcourses} turmas</a>.';
...
$string['messageprovider:courserequestapproved'] = 'Notificação de pedido de aprovação de criação de turma';
$string['messageprovider:courserequested'] = 'Notificação de pedido de criação de turma';
$string['messageprovider:courserequestrejected'] = 'Notificação de rejeição de pedido de criação de turma';
...
$string['missingcategory'] = 'Você precisa escolher um curso';
...
$string['move'] = 'Mover';
$string['movecategoriessuccess'] = 'Movida com sucesso {$a->count} cursos para o curso \'{$a->to}\'';
$string['movecategoriestotopsuccess'] = 'Movidas {$a->count} cursos para o nível superior';
$string['movecategorycontentto'] = 'Mover para';
$string['movecategorysuccess'] = 'Movida com sucesso o curso \'{$a->moved}\'  para a categoria \'{$a->to}\'';
$string['movecategoryto'] = 'Mova o curso para:';
$string['movecategorytotopsuccess'] = 'Movida o curso \'{$a->moved}\' para o nível superior';
$string['movecontent'] = 'Mover {$a}';
$string['movecontentstoanothercategory'] = 'Mover conteúdos para outro curso';
...
$string['moveselectedcategoriesto'] = 'Movo cursos selecionadas para';
$string['moveselectedcoursesto'] = 'Mover turmas selecionados para...';
...
$string['nocourses'] = 'Nenhum turma';
$string['nocoursesfound'] = 'Nenhum turma encontrado com as palavras \'{$a}\'';
$string['nocoursesyet'] = 'Nenhum turma neste curso';
...
$string['nofilesyet'] = 'Nenhum arquivo foi enviado ao seu turma ainda';
...
$string['noimagesyet'] = 'Nenhuma imagem foi enviada ao seu turma ainda';
...
$string['nopendingcourses'] = 'Não há pedido de aprovação de turma pendente';
$string['nopotentialadmins'] = 'Nenhum potencial administrador';
$string['nopotentialcreators'] = 'Nenhum potencial criador de turmas';
...
$string['nostudentsyet'] = 'Nenhum estudante inscrito nesta turma ainda';
...
$string['noteachersyet'] = 'Este turma ainda não tem professores';
$string['notenrolled'] = '{$a} não está inscrito nesta turma';
$string['notenrolledprofile'] = 'Este perfil não é disponível porque este usuário não está inscrito nesta turma';
...
$string['novalidcourses'] = 'Não há turmas válidos a serem mostrados';
$string['now'] = 'agora';
$string['numattempts'] = '{$a} erros de login';
$string['numberofcourses'] = 'Número de turmas';
...
$string['paymentrequired'] = 'Este turma requer o pagamento da taxa de inscrição antes do acesso.';
...
$string['paymentthanks'] = 'Pagamento concluído! Agora você já está inscrito no seguinte turma:<br />"{$a}"';
...
$string['potentialcreators'] = 'Potenciais criadores de turmas';
...
$string['profilenotshown'] = 'Esta descrição de perfil não será mostrada até que esta pessoa seja inscrita em pelo menos um turma.';
...
$string['removecreator'] = 'Remover criador de turma';
...
$string['requestcourse'] = 'Requerer a criação de um turma';
...
$string['requirespayment'] = 'O acesso a esta turma só é possível após o pagamento da taxa de inscrição';
$string['reset'] = 'Reconfigurar';
$string['resetcomponent'] = 'Componente';
$string['resetcourse'] = 'Reconfigurar turma';
$string['resetinfo'] = 'Esta página permite que você esvazie os dados de um turma ou de um usuário, sem excluir as atividades e outras configurações. Por favor lembre-se que fazendo isto estes dados serão cancelados para sempre!';
...
$string['resettable'] = 'Repor as preferências tabela';
$string['resettask'] = 'Tarefa';
$string['resettodefaults'] = 'Usar padrão';
$string['resortcourses'] = 'Ordenar turmas';
$string['resortsubcategoriesby'] = 'Ordenar subcursos por {$a} em ordem crescente';
$string['resortsubcategoriesbyreverse'] = 'Ordenar subcursos por {$a} em ordem decrescente';
...
$string['restorecoursenow'] = 'Fazer restauração desta turma agora!';
...
$string['rolerenaming_help'] = 'Esta configuração permite alterar os nomes  dos papéis exibidos na turma. Apenas o nome exibido é alterado - permissões do papel não são afetadas. Novos nomes de papéis aparecerão na página de participantes do turma e em outros lugares dentro do turma. Se o papel renomeado é um que o administrador tenha selecionado como um papel de gerente de turma, o nome do novo papel também será exibido na listagem de turmas.';
$string['roles'] = 'Papéis';
$string['rss'] = 'RSS';
...
$string['searchcourses'] = 'Buscar turmas';
...
$string['selectacategory'] = 'Por favor seleccione um curso';
$string['selectacountry'] = 'Selecione um país';
$string['selectacourse'] = 'Selecione um turma';
...
$string['selectcategorysort'] = 'Quais cursos você gostaria de ordenar?';
$string['selectcategorysortby'] = 'Selecione como você gostaria de ordenar as cursos';
...
$string['setcategorytheme'] = 'Definir tema para o curso';
...
$string['shortnamecourse_help'] = '<P>Muitas instituições adotam um nome breve ou código para identificar um turma, algo como
   BP102 ou COMMS.  Se o seu turma não corresponde a um nome breve real, crie um. Este
...
$string['showblockcourse'] = 'Mostrar lista de turmas que contém o bloco';
...
<p>Para restringir o acesso ao Relatório de Notas apenas aos professores, é necessário desabilitar a visualização no painel de configuração da turma. Este procedimento é útil também nos casos em que o turma não prevê o uso de atividades com avaliação correspondente. Isto não impede que atividades individuais utilizem ou atribuam notas, apenas desativa a exibição da página de relatório para os estudantes.</p>';
$string['showingacourses'] = 'Mostrando todos os {$a} turmas';
$string['showingxofycourses'] = 'Mostranda turmas de {$a->start} até {$a->end} de um total de {$a->total} turmas';
$string['showlistofcourses'] = 'Mostrar  a lista das turmas';
$string['showmodulecourse'] = 'Mostrar lista de turmas que contém a atividade';
...
$string['sitefilesused'] = 'Arquivos do site usados nesta turma';
...
$string['skiptocategorylisting'] = 'Saltar para as listas de cursos';
$string['skiptocoursedetails'] = 'Saltar para as informações detalhadas da turma';
$string['skiptocourselisting'] = 'Saltar para a lista de turmas';
$string['skypeid'] = 'ID Skype';
$string['socialheadline'] = 'Forum social -  tópicos mais recentes';
$string['someallowguest'] = 'Alguns turmas podem permitir o acesso a visitantes';
...
$string['starpending'] = '([*] = aprovação de turma pendente)';
$string['startdate'] = 'Data de início da turma';
$string['startdate_help'] = 'Esta configuração determina o início da primeira semana para um turma em formato semanal. Também determina a data inicial em que os logs das atividades da turma estarão disponíveis. Se o turma é redefinido e a data de início do turma alterado, todas as datas do turma serão movidos em relação à nova data de início.';
...
$string['statsnodata'] = 'Nenhum dado disponível usando esta combinação de turma e período.';
$string['statsnodatauser'] = 'Nenhuma data disponível usando esta combinação de turma, usuário e período';
...
$string['statsreport9'] = 'Logins (turma principal)';
...
$string['studentnotallowed'] = 'Sinto muito, mas você não pode entrar nesta turma como \'{$a}\'';
$string['students'] = 'Estudantes';
$string['studentsandteachers'] = 'Estudantes e professores';
$string['subcategories'] = 'Subcursos';
...
$string['therearecourses'] = 'Há {$a} turmas';
$string['thereareno'] = 'Não há {$a} nesta turma';
$string['thiscategory'] = 'Esto curso';
$string['thiscategorycontains'] = 'Esto curso contém';
$string['time'] = 'Hora';
...
$string['updatethiscourse'] = 'Atualizar esta turma';
...
$string['viewallcoursescategories'] = 'Ver todos as turmas e cursos';
$string['viewallsubcategories'] = 'Ver todas as subcursos';
...
$string['visible_help'] = 'Esta configuração determina se a turma aparece na lista de turmas. Além de professores e administradores, os demais usuários não têm permissão para entrar no turma.';
$string['visibletostudents'] = 'Visível a {$a}';
$string['warning'] = 'Aviso';
$string['warningdeleteresource'] = 'Atenção: {$a} é citado em um recurso. Você quer atualizar este returma?';
...
$string['writingcategoriesandquestions'] = 'Escrevendo cursos e questões';
...
$string['youneedtoenrol'] = 'Para realizar esta ação você precisa estar inscrito nesta turma.';
