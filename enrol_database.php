...
$string['defaultcategory'] = 'Categoria padrão de turmas novos';
$string['defaultcategory_desc'] = 'Categoria padrão para turmas auto-criados. Usado quando não é especificada o curso ou a mesma não é encontrada.';
...
$string['ignorehiddencourses'] = 'Ignorar turmas ocultos';
$string['ignorehiddencourses_desc'] = 'Se habilitado, os usuários não  serão inscritos em turmas que estão definidos como não disponíveis para os alunos.';
$string['localcategoryfield'] = 'Campo do curso local';
...
$string['newcoursecategory'] = 'Novo campo do curso de turmas';
...
$string['newcoursetable'] = 'Tabela de novas turmas remotos';
$string['newcoursetable_desc'] = 'Especifique o nome da tabela que contém a lista das turmas que devem ser criados automaticamente. Se estiver vazio, significa não criar turmas.';
$string['pluginname'] = 'Banco de Dados Externo';
$string['pluginname_desc'] = 'Você pode usar um banco de dados externo (de quase todo tipo) para controlar a sua matrícula. Presume-se que o seu banco de dados externo contém pelo menos um campo com a identificação da turma, e outro com a identificação de usuário. Estes serão comparados com os campos que você escolher do turma e as tabelas de usuário locais.';
$string['remotecoursefield'] = 'O nome do campo na tabela remota que nós estamos usando para comparar com entradas na tabela turma.';
...
$string['settingsheadernewcourses'] = 'Criação de novas turmas';
$string['settingsheaderremote'] = 'Sincronização de inscrição remota ';
$string['templatecourse'] = 'Novo modelo de turma';
$string['templatecourse_desc'] = 'Opcional: turmas auto-criados podem copiar as configurações de um turma modelo. Digite aqui o nome abreviado da turma modelo.';
