...
$string['newcoursetable_desc'] = 'Especifique o nome da tabela que contém a lista das turmas que devem ser criados automaticamente. Se estiver vazio, significa não criar cursos.';
