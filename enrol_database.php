...
$string['defaultcategory_desc'] = 'Categoria padrão para turmas auto-criados. Usado quando não é especificada a categoria ou a mesma não é encontrada.';
...
$string['newcoursecategory'] = 'Novo campo da categoria de turmas';
