...
$string['cannotgetcoursecontents'] = 'Impossível obter conteúdos da turma';
...
$string['error'] = 'Erro: {$a}';
$string['errorcatcontextnotvalid'] = 'Você não pode executar funções no contexto do curso (Id da categoria: {$a->catid}). O erro de contexto foi: {$a->message}';
$string['errorcodes'] = 'Mensagem de erro';
$string['errorcoursecontextnotvalid'] = 'Você não pode executar funções no contexto da turma (Id do turma: {$a->courseid}). O erro de contexto foi: {$a->message}';
