...
$string['advertise'] = 'Anuncie esta turma para pessoas se inscreverem';
$string['advertised'] = 'Anunciados';
$string['advertiseon'] = 'Anuncie esta turma em {$a}';
$string['advertiseonhub'] = 'Anuncie esta turma em um hub';
$string['advertiseonmoodleorg'] = 'Anuncie esse turma em moodle.org';
$string['advertisepublication_help'] = 'Anunciar seu turma em um servidor de hub da comunidade permite que as pessoas encontrem o seu turma e possam se inscrever nele.';
$string['all'] = 'Todos';
$string['allowglobalsearch'] = 'Publicar este hub e permitir uma pesquisa global de todos as turmas';
...
$string['audience_help'] = 'Selecionar a público-alvo da turma.';
...
$string['communityremoved'] = 'O link para esta turma foi removido de sua lista';
...
$string['contributornames_help'] = 'Você pode usar este campo para listar os nomes de qualquer outra pessoa que contribuiu para esta turma.';
$string['coursemap'] = 'Mapa da turma';
$string['coursename'] = 'Nome';
$string['courseprivate'] = 'Privado';
$string['coursepublic'] = 'Público';
$string['coursepublished'] = 'Este turma foi publicado com sucesso em \'{$a}\'.';
$string['courseshortname'] = 'Nome curto';
$string['courseshortname_help'] = 'Insira um nome curto para seu turma. Ele não precisa ser único';
$string['coursesnumber'] = 'Número de turmas ({$a})';
$string['courseunpublished'] = 'A turma {$a->courseshortname} já não é publicado em {$a->hubname}.';
$string['courseurl'] = 'URL da turma';
$string['courseurl_help'] = 'Este é o URL do seu turma. Este URL é mostrado como um link nos resultados de busca.';
$string['creatorname'] = 'Criador';
$string['creatorname_help'] = 'O criador é o criador de turmas.';
$string['creatornotes'] = 'Anotações sobre o criador';
$string['creatornotes_help'] = 'Notas do criador são um guia para professores sobre como usar a turma.';
...
$string['demourl_help'] = 'Entre com o URL do demo do seu turma. Por padrão este é o URL do seu turma. O URL do demo é mostrado como um link no resultado de buca.';
$string['description'] = 'Descrição';
$string['description_help'] = 'Este texto descritivo será mostrado na lista de turmas no hub.';
$string['detectednotexistingpublication'] = '{$a->hubname} está listando um turma que não existe mais. Inorme ao administrador deste hub que a publicação {$a->id} deve ser removida.';
$string['downloadable'] = 'Downloadable';
$string['educationallevel'] = 'Nível de escolaridade';
$string['educationallevel_help'] = 'Selecione o nível educacional mais adequado para a turma.';
...
$string['errorcourseinfo'] = 'Um erro ocorreu ao receber os metadados da turma a partir do hub ({$a}). Por favor, tente novamente para acessar os metadados turma do hub acessando esta página mais tarde. Caso contrário, você pode decidir continuar o processo de inscrição com os metadados padrão a seguir.';
$string['errorcoursepublish'] = 'Ocorreu um erro durante a publicação da turma ({$a}). Por favor, tente novamente mais tarde.';
...
$string['errorunpublishcourses'] = 'Devido um erro inesperado, as turmas não podem ser excluídos do hub. Tente novamente mais tarde (recomendado) ou entre em contato com o administrador do hub.';
$string['existingscreenshotnumber'] = '{$a} screenshots existentes. Você será capaz de ver essas imagens nesta página, somente se o administrador do hub permitir em seu turma.';
...
$string['geolocation_help'] = 'No futuro poderemos fornecer pesquisa baseado na localização. Se você quiser especificar a localização do seu turma use um valor latitude/longitude aqui (Exemplo: -31.947884,115.871285). Uma forma de descobrir isto é utilizar o Google Maps.';
$string['hub'] = 'Hub';
...
$string['language_help'] = 'O idioma principal da turma.';
$string['lasttimechecked'] = 'Última verificação';
$string['licence'] = 'Licença';
$string['licence_help'] = 'Selecione a licença com a qual você deseja distribuir o seu turma.';
$string['logourl'] = 'Link do logo';
$string['modulenumberaverage'] = 'Número médio de módulos da turma ({$a})';
$string['moodleorg'] = 'Moodle.org';
$string['mustselectsubject'] = 'Você deve selecionar um assunto';
$string['name'] = 'Nome';
$string['name_help'] = 'Esse nome será exibido na listagem da turma.';
...
$string['none'] = 'Nenhum';
$string['nosearch'] = 'Não publique hub ou turmas';
$string['notregisteredonhub'] = 'O administrador precisa registrar este site em pelo menos um hub para que você possa publicar um turma. Entre em contato com o administrador do site.';
...
$string['publicationinfo'] = 'Informações sobre publicação de turma';
...
$string['publisheremail_help'] = 'O endereço de e-mail do editor permite que o administrador do hub possa alertar o editor sobre todas as alterações no status da turma publicado.';
$string['publishername'] = 'Editor';
$string['publishername_help'] = 'O editor é a pessoa ou organização que é editora oficial da turma. A menos que você esteja publicando o turma em nome de outra pessoa, usualmente o editor é você mesmo.';
...
$string['registrationconfirmedon'] = 'Agora você está registrado no hub {$a}. Agora você pode publicar turmas neste hub, utilizando o link "Publicar" nos menus administrativos.';
...
$string['resourcesnumber'] = 'Número de returmas ({$a})';
$string['restartregistration'] = 'Recomeçar o registro';
$string['roleassignmentsnumber'] = 'Número de papéis atribuídos ({$a})';
$string['screenshots'] = 'Screenshots';
$string['screenshots_help'] = 'Quaisquer screenshots da turma serão exibidos nos resultados de busca.';
...
$string['selecthubinfo'] = 'Um hub comunidade é um servidor que lista as turmas. Você só pode publicar seus turmas em hubs que este site está registrado com Moodle. Se o hub que você deseja não estiver listado abaixo, entre em contato com o administrador do site.';
...
$string['sendingcourse'] = 'Envianda turma';
$string['sendingsize'] = 'Por favor, aguarde o envio do arquivo da turma ({$a->total}Mb)...';
$string['sent'] = '...terminado';
$string['settings'] = 'Configurações';
$string['settingsupdated'] = 'As configurações foram atualizadas.';
$string['share'] = 'Permitir o download desta turma';
$string['shared'] = 'Compartilhado';
$string['shareon'] = 'Enviar esta turma para  {$a}';
$string['shareonhub'] = 'Enviar esta turma para o hub';
$string['sharepublication_help'] = 'Subindo esta turma para o servidor de hub da comunidade será possível para outras pessoas baixá-lo e ou instalá-lo em seus próprios sites Moodle.';
...
$string['subject_help'] = 'Selecione o tema principal abordado pela turma.';
$string['tags'] = 'Tags';
$string['tags_help'] = 'Tags ajudam a classificar melhor o seu turma e também a encontrá-lo nas buscas. Por favor use palavras simples e significativas, e separe-as com uma vírgula. Exemplo: matemática, álgebra, geometria.';
...
$string['unpublishalladvertisedcourses'] = 'Remover todos as turmas publicados em um hub';
$string['unpublishalluploadedcourses'] = 'Removido todos as turmas que foram enviados a um hub';
$string['unpublishconfirmation'] = 'Você realmente deseja remover a turma "{$a->courseshortname}" do hub "{$a->hubname}"';
$string['unpublishcourse'] = 'Remover a publicação {$a}';
$string['unregister'] = 'Cancelar o registro';
$string['unregisterconfirmation'] = 'Você está prestes a cancelar este site a partir do {$a} hub. Uma vez que você desligá-lo, você não será capaz de gerenciar todos as turmas que você deixou lá. Tem certeza que deseja cancelar o registro?';
...
$string['xmlrpcdisabledcommunity'] = 'A extensão XML-PRC não está habilitada no servidor. Você não pode buscar e baixar turmas.';
$string['xmlrpcdisabledpublish'] = 'A extensão XML-RPC não está habilitada no servidor. Você não pode publicar turmas ou gerenciar turmas publicados.';
