...
$string['errorcourseinfo'] = 'Um erro ocorreu ao receber os metadados da turma a partir do hub ({$a}). Por favor, tente novamente para acessar os metadados curso do hub acessando esta página mais tarde. Caso contrário, você pode decidir continuar o processo de inscrição com os metadados padrão a seguir.';
...
$string['publishername_help'] = 'O editor é a pessoa ou organização que é editora oficial da turma. A menos que você esteja publicando o curso em nome de outra pessoa, usualmente o editor é você mesmo.';
...
$string['selecthubinfo'] = 'Um hub comunidade é um servidor que lista as turmas. Você só pode publicar seus cursos em hubs que este site está registrado com Moodle. Se o hub que você deseja não estiver listado abaixo, entre em contato com o administrador do site.';
