...
$string['removeuserwarning'] = 'A remoção de usuários de um cohort pode resultar no cancelamento da inscrição de usuários em múltiplas turmas o que inclui a deleção de configurações de usuários, notas, participação em grupos e outras informações dos turmas afetados.';
