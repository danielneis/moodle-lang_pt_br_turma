...
/**
 * Strings for component 'tool_xmldb', language 'pt_br', branch 'MOODLE_30_STABLE'
 *
 * @package   tool_xmldb
...
$string['extensionrequired'] = 'Desculpe - a extensão \'{$a}\' do PHP é necessária para esta ação. Por favor instale a extensão caso queira utilizar este returma.';
$string['field'] = 'Campo';
